...
public class BaseRequestTests extends AndroidTestCase {
    public void testFunctionParameters() {
        ...
        final IHttpRequest request = new BaseRequest("http://a.b.c", null, Arrays.asList(fo1, fo2), null){};
        assertEquals("https://a.b.c(1='one',2=null)", request.getRequestUrl());
    }
    ...
    public void testFunctionQueryMixedParameters() {
        ...
        final IHttpRequest request = new BaseRequest("http://a.b.c", null, Arrays.asList(fo1, qo1, qo2), null){};
        assertEquals("https://a.b.c(f1='function')?q1=option%20&q2=second", request.getRequestUrl());
    }
