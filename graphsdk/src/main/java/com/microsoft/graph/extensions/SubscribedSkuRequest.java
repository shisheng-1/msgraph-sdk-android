...
public class SubscribedSkuRequest extends BaseSubscribedSkuRequest implements ISubscribedSkuRequest {
     ...
     */
    public SubscribedSkuRequest(final String requestUrl, final IBaseClient client, final List<Option> options) {
        super(requestUrl, client, options, SubscribedSku.class);
    }
}
