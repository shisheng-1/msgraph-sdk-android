...
public class WorkbookFunctionsTypeRequestBuilder extends BaseWorkbookFunctionsTypeRequestBuilder implements IWorkbookFunctionsTypeRequestBuilder {
     ...
     */
    public WorkbookFunctionsTypeRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement value) {
