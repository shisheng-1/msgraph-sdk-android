...
public class WorkbookFunctionsAverageRequestBuilder extends BaseWorkbookFunctionsAverageRequestBuilder implements IWorkbookFunctionsAverageRequestBuilder {
     ...
     */
    public WorkbookFunctionsAverageRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
