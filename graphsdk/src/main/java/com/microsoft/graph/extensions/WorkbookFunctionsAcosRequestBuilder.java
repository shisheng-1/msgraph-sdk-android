...
public class WorkbookFunctionsAcosRequestBuilder extends BaseWorkbookFunctionsAcosRequestBuilder implements IWorkbookFunctionsAcosRequestBuilder {
     ...
     */
    public WorkbookFunctionsAcosRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
