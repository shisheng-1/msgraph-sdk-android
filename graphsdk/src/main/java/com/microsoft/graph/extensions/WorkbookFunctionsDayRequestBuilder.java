...
public class WorkbookFunctionsDayRequestBuilder extends BaseWorkbookFunctionsDayRequestBuilder implements IWorkbookFunctionsDayRequestBuilder {
     ...
     */
    public WorkbookFunctionsDayRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement serialNumber) {
