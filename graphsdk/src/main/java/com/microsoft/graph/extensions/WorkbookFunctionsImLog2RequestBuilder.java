...
public class WorkbookFunctionsImLog2RequestBuilder extends BaseWorkbookFunctionsImLog2RequestBuilder implements IWorkbookFunctionsImLog2RequestBuilder {
     ...
     */
    public WorkbookFunctionsImLog2RequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
