...
public class WorkbookFunctionsSkew_pRequestBuilder extends BaseWorkbookFunctionsSkew_pRequestBuilder implements IWorkbookFunctionsSkew_pRequestBuilder {
     ...
     */
    public WorkbookFunctionsSkew_pRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
