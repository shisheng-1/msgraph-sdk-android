...
public class WorkbookFunctionsXorRequestBuilder extends BaseWorkbookFunctionsXorRequestBuilder implements IWorkbookFunctionsXorRequestBuilder {
     ...
     */
    public WorkbookFunctionsXorRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
