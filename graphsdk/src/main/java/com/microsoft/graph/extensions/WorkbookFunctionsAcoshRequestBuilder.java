...
public class WorkbookFunctionsAcoshRequestBuilder extends BaseWorkbookFunctionsAcoshRequestBuilder implements IWorkbookFunctionsAcoshRequestBuilder {
     ...
     */
    public WorkbookFunctionsAcoshRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
