...
public class WorkbookFunctionsModRequestBuilder extends BaseWorkbookFunctionsModRequestBuilder implements IWorkbookFunctionsModRequestBuilder {
     ...
     */
    public WorkbookFunctionsModRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number, final com.google.gson.JsonElement divisor) {
