...
public class ReportRootGetSharePointActivityUserDetailRequestBuilder extends BaseReportRootGetSharePointActivityUserDetailRequestBuilder implements IReportRootGetSharePointActivityUserDetailRequestBuilder {
     ...
     */
    public ReportRootGetSharePointActivityUserDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.microsoft.graph.model.DateOnly date) {
     ...
     * @param requestOptions The options for this request
     */
    public ReportRootGetSharePointActivityUserDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
