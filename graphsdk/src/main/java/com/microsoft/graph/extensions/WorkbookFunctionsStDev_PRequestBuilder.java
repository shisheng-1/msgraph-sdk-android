...
public class WorkbookFunctionsStDev_PRequestBuilder extends BaseWorkbookFunctionsStDev_PRequestBuilder implements IWorkbookFunctionsStDev_PRequestBuilder {
     ...
     */
    public WorkbookFunctionsStDev_PRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
