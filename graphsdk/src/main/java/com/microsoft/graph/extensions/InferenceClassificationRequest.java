...
public class InferenceClassificationRequest extends BaseInferenceClassificationRequest implements IInferenceClassificationRequest {
     ...
     */
    public InferenceClassificationRequest(final String requestUrl, final IBaseClient client, final List<Option> options) {
        super(requestUrl, client, options, InferenceClassification.class);
    }
}
