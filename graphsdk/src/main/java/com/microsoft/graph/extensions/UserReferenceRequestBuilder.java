// Template Source: Templates/Android/extensions/EntityReferenceRequestBuilder.java.tt
// ------------------------------------------------------------------------------
...
public class UserReferenceRequestBuilder extends BaseUserReferenceRequestBuilder implements IUserReferenceRequestBuilder {
     ...
     */
    public UserReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options) {
