...
public class WorkbookFunctionsGeStepRequestBuilder extends BaseWorkbookFunctionsGeStepRequestBuilder implements IWorkbookFunctionsGeStepRequestBuilder {
     ...
     */
    public WorkbookFunctionsGeStepRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number, final com.google.gson.JsonElement step) {
