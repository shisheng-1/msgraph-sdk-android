...
public class WorkbookFunctionsIsNumberRequestBuilder extends BaseWorkbookFunctionsIsNumberRequestBuilder implements IWorkbookFunctionsIsNumberRequestBuilder {
     ...
     */
    public WorkbookFunctionsIsNumberRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement value) {
