...
public class WorkbookFunctionsFactDoubleRequestBuilder extends BaseWorkbookFunctionsFactDoubleRequestBuilder implements IWorkbookFunctionsFactDoubleRequestBuilder {
     ...
     */
    public WorkbookFunctionsFactDoubleRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
