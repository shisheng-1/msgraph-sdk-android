...
public class WorkbookFunctionsVarPARequestBuilder extends BaseWorkbookFunctionsVarPARequestBuilder implements IWorkbookFunctionsVarPARequestBuilder {
     ...
     */
    public WorkbookFunctionsVarPARequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
