...
public class ReferenceAttachmentRequest extends BaseReferenceAttachmentRequest implements IReferenceAttachmentRequest {
     ...
     */
    public ReferenceAttachmentRequest(final String requestUrl, final IBaseClient client, final List<Option> options) {
        super(requestUrl, client, options, ReferenceAttachment.class);
    }
}
