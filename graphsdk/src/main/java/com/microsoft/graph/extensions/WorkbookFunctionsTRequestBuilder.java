...
public class WorkbookFunctionsTRequestBuilder extends BaseWorkbookFunctionsTRequestBuilder implements IWorkbookFunctionsTRequestBuilder {
     ...
     */
    public WorkbookFunctionsTRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement value) {
