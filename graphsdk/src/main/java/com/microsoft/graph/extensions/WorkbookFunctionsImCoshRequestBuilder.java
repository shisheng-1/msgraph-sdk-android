...
public class WorkbookFunctionsImCoshRequestBuilder extends BaseWorkbookFunctionsImCoshRequestBuilder implements IWorkbookFunctionsImCoshRequestBuilder {
     ...
     */
    public WorkbookFunctionsImCoshRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
