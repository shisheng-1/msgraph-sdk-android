...
public class WorkbookFunctionsConcatenateRequestBuilder extends BaseWorkbookFunctionsConcatenateRequestBuilder implements IWorkbookFunctionsConcatenateRequestBuilder {
     ...
     */
    public WorkbookFunctionsConcatenateRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
