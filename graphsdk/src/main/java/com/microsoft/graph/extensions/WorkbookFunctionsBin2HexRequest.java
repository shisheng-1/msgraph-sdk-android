...
/**
 * The class for the Workbook Functions Bin2Hex Request.
 */
public class WorkbookFunctionsBin2HexRequest extends BaseWorkbookFunctionsBin2HexRequest implements IWorkbookFunctionsBin2HexRequest {
     ...
     */
    public WorkbookFunctionsBin2HexRequest(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
