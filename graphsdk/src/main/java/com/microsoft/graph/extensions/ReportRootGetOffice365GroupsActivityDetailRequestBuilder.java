...
public class ReportRootGetOffice365GroupsActivityDetailRequestBuilder extends BaseReportRootGetOffice365GroupsActivityDetailRequestBuilder implements IReportRootGetOffice365GroupsActivityDetailRequestBuilder {
     ...
     */
    public ReportRootGetOffice365GroupsActivityDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.microsoft.graph.model.DateOnly date) {
     ...
     * @param requestOptions The options for this request
     */
    public ReportRootGetOffice365GroupsActivityDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
