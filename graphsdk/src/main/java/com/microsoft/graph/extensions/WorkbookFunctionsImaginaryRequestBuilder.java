...
public class WorkbookFunctionsImaginaryRequestBuilder extends BaseWorkbookFunctionsImaginaryRequestBuilder implements IWorkbookFunctionsImaginaryRequestBuilder {
     ...
     */
    public WorkbookFunctionsImaginaryRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
