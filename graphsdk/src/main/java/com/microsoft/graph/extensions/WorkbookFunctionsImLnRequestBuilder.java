...
public class WorkbookFunctionsImLnRequestBuilder extends BaseWorkbookFunctionsImLnRequestBuilder implements IWorkbookFunctionsImLnRequestBuilder {
     ...
     */
    public WorkbookFunctionsImLnRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
