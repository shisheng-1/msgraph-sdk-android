...
public class WorkbookFunctionsMinARequestBuilder extends BaseWorkbookFunctionsMinARequestBuilder implements IWorkbookFunctionsMinARequestBuilder {
     ...
     */
    public WorkbookFunctionsMinARequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
