...
public class WorkbookFunctionsTanhRequestBuilder extends BaseWorkbookFunctionsTanhRequestBuilder implements IWorkbookFunctionsTanhRequestBuilder {
     ...
     */
    public WorkbookFunctionsTanhRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
