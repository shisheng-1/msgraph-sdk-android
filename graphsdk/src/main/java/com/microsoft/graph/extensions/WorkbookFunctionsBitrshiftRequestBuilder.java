...
public class WorkbookFunctionsBitrshiftRequestBuilder extends BaseWorkbookFunctionsBitrshiftRequestBuilder implements IWorkbookFunctionsBitrshiftRequestBuilder {
     ...
     */
    public WorkbookFunctionsBitrshiftRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number, final com.google.gson.JsonElement shiftAmount) {
