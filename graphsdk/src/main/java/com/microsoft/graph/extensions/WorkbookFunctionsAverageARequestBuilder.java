...
public class WorkbookFunctionsAverageARequestBuilder extends BaseWorkbookFunctionsAverageARequestBuilder implements IWorkbookFunctionsAverageARequestBuilder {
     ...
     */
    public WorkbookFunctionsAverageARequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
