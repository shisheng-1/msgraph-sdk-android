...
public class WorkbookFunctionsKurtRequestBuilder extends BaseWorkbookFunctionsKurtRequestBuilder implements IWorkbookFunctionsKurtRequestBuilder {
     ...
     */
    public WorkbookFunctionsKurtRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
