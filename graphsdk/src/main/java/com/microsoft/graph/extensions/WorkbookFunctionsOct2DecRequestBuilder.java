...
public class WorkbookFunctionsOct2DecRequestBuilder extends BaseWorkbookFunctionsOct2DecRequestBuilder implements IWorkbookFunctionsOct2DecRequestBuilder {
     ...
     */
    public WorkbookFunctionsOct2DecRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
