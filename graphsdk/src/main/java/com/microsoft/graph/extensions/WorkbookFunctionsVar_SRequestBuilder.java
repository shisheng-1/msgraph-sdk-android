...
public class WorkbookFunctionsVar_SRequestBuilder extends BaseWorkbookFunctionsVar_SRequestBuilder implements IWorkbookFunctionsVar_SRequestBuilder {
     ...
     */
    public WorkbookFunctionsVar_SRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
