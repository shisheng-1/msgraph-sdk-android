...
public class FileAttachmentRequest extends BaseFileAttachmentRequest implements IFileAttachmentRequest {
     ...
     */
    public FileAttachmentRequest(final String requestUrl, final IBaseClient client, final List<Option> options) {
        super(requestUrl, client, options, FileAttachment.class);
    }
}
