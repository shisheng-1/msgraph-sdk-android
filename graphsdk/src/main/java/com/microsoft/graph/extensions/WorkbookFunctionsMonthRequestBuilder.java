...
public class WorkbookFunctionsMonthRequestBuilder extends BaseWorkbookFunctionsMonthRequestBuilder implements IWorkbookFunctionsMonthRequestBuilder {
     ...
     */
    public WorkbookFunctionsMonthRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement serialNumber) {
