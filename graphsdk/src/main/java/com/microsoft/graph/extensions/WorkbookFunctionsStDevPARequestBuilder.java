...
public class WorkbookFunctionsStDevPARequestBuilder extends BaseWorkbookFunctionsStDevPARequestBuilder implements IWorkbookFunctionsStDevPARequestBuilder {
     ...
     */
    public WorkbookFunctionsStDevPARequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
