...
public class WorkbookFunctionsT_InvRequestBuilder extends BaseWorkbookFunctionsT_InvRequestBuilder implements IWorkbookFunctionsT_InvRequestBuilder {
     ...
     */
    public WorkbookFunctionsT_InvRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement probability, final com.google.gson.JsonElement degFreedom) {
