...
public class WorkbookFunctionsSechRequestBuilder extends BaseWorkbookFunctionsSechRequestBuilder implements IWorkbookFunctionsSechRequestBuilder {
     ...
     */
    public WorkbookFunctionsSechRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
