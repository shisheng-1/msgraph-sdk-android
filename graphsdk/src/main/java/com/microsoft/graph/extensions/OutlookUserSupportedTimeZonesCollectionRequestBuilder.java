...
public class OutlookUserSupportedTimeZonesCollectionRequestBuilder extends BaseOutlookUserSupportedTimeZonesCollectionRequestBuilder implements IOutlookUserSupportedTimeZonesCollectionRequestBuilder {
     ...
     */
    public OutlookUserSupportedTimeZonesCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     * @param requestOptions The options for this request
     */
    public OutlookUserSupportedTimeZonesCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final TimeZoneStandard timeZoneStandard) {
