...
public class ReportRootGetEmailAppUsageUserDetailRequestBuilder extends BaseReportRootGetEmailAppUsageUserDetailRequestBuilder implements IReportRootGetEmailAppUsageUserDetailRequestBuilder {
     ...
     */
    public ReportRootGetEmailAppUsageUserDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.microsoft.graph.model.DateOnly date) {
     ...
     * @param requestOptions The options for this request
     */
    public ReportRootGetEmailAppUsageUserDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
