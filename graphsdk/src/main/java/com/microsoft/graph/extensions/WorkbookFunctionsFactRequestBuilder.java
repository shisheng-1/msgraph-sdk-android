...
public class WorkbookFunctionsFactRequestBuilder extends BaseWorkbookFunctionsFactRequestBuilder implements IWorkbookFunctionsFactRequestBuilder {
     ...
     */
    public WorkbookFunctionsFactRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
