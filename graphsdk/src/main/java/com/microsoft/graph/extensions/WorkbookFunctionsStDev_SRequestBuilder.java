...
public class WorkbookFunctionsStDev_SRequestBuilder extends BaseWorkbookFunctionsStDev_SRequestBuilder implements IWorkbookFunctionsStDev_SRequestBuilder {
     ...
     */
    public WorkbookFunctionsStDev_SRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
