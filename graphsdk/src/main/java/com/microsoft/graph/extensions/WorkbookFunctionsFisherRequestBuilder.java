...
public class WorkbookFunctionsFisherRequestBuilder extends BaseWorkbookFunctionsFisherRequestBuilder implements IWorkbookFunctionsFisherRequestBuilder {
     ...
     */
    public WorkbookFunctionsFisherRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement x) {
