...
public class WorkbookFunctionsGaussRequestBuilder extends BaseWorkbookFunctionsGaussRequestBuilder implements IWorkbookFunctionsGaussRequestBuilder {
     ...
     */
    public WorkbookFunctionsGaussRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement x) {
