...
public class WorkbookFilterApplyCustomFilterRequestBuilder extends BaseWorkbookFilterApplyCustomFilterRequestBuilder implements IWorkbookFilterApplyCustomFilterRequestBuilder {
     ...
     */
    public WorkbookFilterApplyCustomFilterRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final String criteria1, final String criteria2, final String oper) {
