...
public class WorkbookFunctionsTruncRequestBuilder extends BaseWorkbookFunctionsTruncRequestBuilder implements IWorkbookFunctionsTruncRequestBuilder {
     ...
     */
    public WorkbookFunctionsTruncRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number, final com.google.gson.JsonElement numDigits) {
