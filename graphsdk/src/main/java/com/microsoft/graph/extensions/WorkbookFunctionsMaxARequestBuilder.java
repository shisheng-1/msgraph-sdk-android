...
public class WorkbookFunctionsMaxARequestBuilder extends BaseWorkbookFunctionsMaxARequestBuilder implements IWorkbookFunctionsMaxARequestBuilder {
     ...
     */
    public WorkbookFunctionsMaxARequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
