...
public class WorkbookFunctionsLnRequestBuilder extends BaseWorkbookFunctionsLnRequestBuilder implements IWorkbookFunctionsLnRequestBuilder {
     ...
     */
    public WorkbookFunctionsLnRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
