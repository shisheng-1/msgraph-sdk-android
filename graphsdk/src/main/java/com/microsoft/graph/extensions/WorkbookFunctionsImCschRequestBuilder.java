...
public class WorkbookFunctionsImCschRequestBuilder extends BaseWorkbookFunctionsImCschRequestBuilder implements IWorkbookFunctionsImCschRequestBuilder {
     ...
     */
    public WorkbookFunctionsImCschRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
