...
public class ReportRootGetTeamsUserActivityUserDetailRequestBuilder extends BaseReportRootGetTeamsUserActivityUserDetailRequestBuilder implements IReportRootGetTeamsUserActivityUserDetailRequestBuilder {
     ...
     */
    public ReportRootGetTeamsUserActivityUserDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.microsoft.graph.model.DateOnly date) {
     ...
     * @param requestOptions The options for this request
     */
    public ReportRootGetTeamsUserActivityUserDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
