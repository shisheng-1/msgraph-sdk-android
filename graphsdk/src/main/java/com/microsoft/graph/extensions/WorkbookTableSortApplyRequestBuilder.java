...
public class WorkbookTableSortApplyRequestBuilder extends BaseWorkbookTableSortApplyRequestBuilder implements IWorkbookTableSortApplyRequestBuilder {
     ...
     */
    public WorkbookTableSortApplyRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final List<WorkbookSortField> fields, final Boolean matchCase, final String method) {
