...
public class WorkbookFunctionsCountRequestBuilder extends BaseWorkbookFunctionsCountRequestBuilder implements IWorkbookFunctionsCountRequestBuilder {
     ...
     */
    public WorkbookFunctionsCountRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
