...
public class WorkbookFunctionsLog10RequestBuilder extends BaseWorkbookFunctionsLog10RequestBuilder implements IWorkbookFunctionsLog10RequestBuilder {
     ...
     */
    public WorkbookFunctionsLog10RequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
