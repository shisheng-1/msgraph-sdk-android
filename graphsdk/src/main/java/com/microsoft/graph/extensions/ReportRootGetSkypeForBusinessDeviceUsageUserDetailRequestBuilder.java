...
public class ReportRootGetSkypeForBusinessDeviceUsageUserDetailRequestBuilder extends BaseReportRootGetSkypeForBusinessDeviceUsageUserDetailRequestBuilder implements IReportRootGetSkypeForBusinessDeviceUsageUserDetailRequestBuilder {
     ...
     */
    public ReportRootGetSkypeForBusinessDeviceUsageUserDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.microsoft.graph.model.DateOnly date) {
     ...
     * @param requestOptions The options for this request
     */
    public ReportRootGetSkypeForBusinessDeviceUsageUserDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
