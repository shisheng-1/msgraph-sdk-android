...
public class WorkbookFunctionsBesselIRequestBuilder extends BaseWorkbookFunctionsBesselIRequestBuilder implements IWorkbookFunctionsBesselIRequestBuilder {
     ...
     */
    public WorkbookFunctionsBesselIRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement x, final com.google.gson.JsonElement n) {
