...
public class WorkbookFunctionsCountARequestBuilder extends BaseWorkbookFunctionsCountARequestBuilder implements IWorkbookFunctionsCountARequestBuilder {
     ...
     */
    public WorkbookFunctionsCountARequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
