...
public class WorkbookFunctionsTanRequestBuilder extends BaseWorkbookFunctionsTanRequestBuilder implements IWorkbookFunctionsTanRequestBuilder {
     ...
     */
    public WorkbookFunctionsTanRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
