...
public class WorkbookFunctionsHex2DecRequestBuilder extends BaseWorkbookFunctionsHex2DecRequestBuilder implements IWorkbookFunctionsHex2DecRequestBuilder {
     ...
     */
    public WorkbookFunctionsHex2DecRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
