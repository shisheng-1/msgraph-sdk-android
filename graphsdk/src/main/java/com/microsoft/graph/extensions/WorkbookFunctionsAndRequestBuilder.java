...
public class WorkbookFunctionsAndRequestBuilder extends BaseWorkbookFunctionsAndRequestBuilder implements IWorkbookFunctionsAndRequestBuilder {
     ...
     */
    public WorkbookFunctionsAndRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
