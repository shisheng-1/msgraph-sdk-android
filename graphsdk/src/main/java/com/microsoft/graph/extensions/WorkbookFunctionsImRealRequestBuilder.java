...
public class WorkbookFunctionsImRealRequestBuilder extends BaseWorkbookFunctionsImRealRequestBuilder implements IWorkbookFunctionsImRealRequestBuilder {
     ...
     */
    public WorkbookFunctionsImRealRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
