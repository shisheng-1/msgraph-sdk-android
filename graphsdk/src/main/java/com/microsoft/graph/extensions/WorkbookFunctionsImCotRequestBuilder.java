...
public class WorkbookFunctionsImCotRequestBuilder extends BaseWorkbookFunctionsImCotRequestBuilder implements IWorkbookFunctionsImCotRequestBuilder {
     ...
     */
    public WorkbookFunctionsImCotRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
