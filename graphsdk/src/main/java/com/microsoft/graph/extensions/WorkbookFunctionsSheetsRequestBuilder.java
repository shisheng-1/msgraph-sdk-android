...
public class WorkbookFunctionsSheetsRequestBuilder extends BaseWorkbookFunctionsSheetsRequestBuilder implements IWorkbookFunctionsSheetsRequestBuilder {
     ...
     */
    public WorkbookFunctionsSheetsRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement reference) {
