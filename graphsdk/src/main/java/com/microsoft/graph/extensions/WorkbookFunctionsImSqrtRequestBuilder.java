...
public class WorkbookFunctionsImSqrtRequestBuilder extends BaseWorkbookFunctionsImSqrtRequestBuilder implements IWorkbookFunctionsImSqrtRequestBuilder {
     ...
     */
    public WorkbookFunctionsImSqrtRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
