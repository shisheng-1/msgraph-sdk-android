...
public class BaseWorkbookFunctionsColumnsRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsColumnsRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement array) {
     ...
     * @return The IWorkbookFunctionsColumnsRequest instance
     */
    public IWorkbookFunctionsColumnsRequest buildRequest(final List<Option> requestOptions) {
