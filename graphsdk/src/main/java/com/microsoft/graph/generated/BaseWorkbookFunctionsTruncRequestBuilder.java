...
public class BaseWorkbookFunctionsTruncRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsTruncRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number, final com.google.gson.JsonElement numDigits) {
     ...
     * @return The IWorkbookFunctionsTruncRequest instance
     */
    public IWorkbookFunctionsTruncRequest buildRequest(final List<Option> requestOptions) {
