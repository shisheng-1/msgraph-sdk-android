...
public class BaseWorkbookFunctionsMaxARequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsMaxARequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsMaxARequest instance
     */
    public IWorkbookFunctionsMaxARequest buildRequest(final List<Option> requestOptions) {
