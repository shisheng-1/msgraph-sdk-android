...
public class BaseWorkbookRangeLastCellRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookRangeLastCellRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookRangeLastCellRequest instance
     */
    public IWorkbookRangeLastCellRequest buildRequest(final List<Option> requestOptions) {
