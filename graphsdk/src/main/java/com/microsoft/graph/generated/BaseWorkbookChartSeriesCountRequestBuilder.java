...
/**
 * The class for the Base Workbook Chart Series Count Request Builder.
 */
public class BaseWorkbookChartSeriesCountRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookChartSeriesCountRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookChartSeriesCountRequest instance
     */
    public IWorkbookChartSeriesCountRequest buildRequest(final List<Option> requestOptions) {
