...
/**
 * The class for the Base Report Root Get Teams Device Usage User Detail Request.
 */
public class BaseReportRootGetTeamsDeviceUsageUserDetailRequest extends BaseRequest implements IBaseReportRootGetTeamsDeviceUsageUserDetailRequest {
     ...
     */
    public BaseReportRootGetTeamsDeviceUsageUserDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
