...
public class BaseWorkbookFunctionsRoundUpRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsRoundUpRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number, final com.google.gson.JsonElement numDigits) {
     ...
     * @return The IWorkbookFunctionsRoundUpRequest instance
     */
    public IWorkbookFunctionsRoundUpRequest buildRequest(final List<Option> requestOptions) {
