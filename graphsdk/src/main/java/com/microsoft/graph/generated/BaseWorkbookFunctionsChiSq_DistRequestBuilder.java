...
public class BaseWorkbookFunctionsChiSq_DistRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsChiSq_DistRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement x, final com.google.gson.JsonElement degFreedom, final com.google.gson.JsonElement cumulative) {
     ...
     * @return The IWorkbookFunctionsChiSq_DistRequest instance
     */
    public IWorkbookFunctionsChiSq_DistRequest buildRequest(final List<Option> requestOptions) {
