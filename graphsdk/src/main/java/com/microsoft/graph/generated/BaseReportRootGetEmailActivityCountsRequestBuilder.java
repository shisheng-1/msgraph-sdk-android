...
public class BaseReportRootGetEmailActivityCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetEmailActivityCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetEmailActivityCountsRequest instance
     */
    public IReportRootGetEmailActivityCountsRequest buildRequest(final java.util.List<Option> requestOptions) {
