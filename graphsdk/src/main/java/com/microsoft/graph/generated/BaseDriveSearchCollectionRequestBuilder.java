...
public class BaseDriveSearchCollectionRequestBuilder extends BaseFunctionRequestBuilder implements IBaseDriveSearchCollectionRequestBuilder {
     ...
     */
    public BaseDriveSearchCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final String q) {
    ...
    public IDriveSearchCollectionRequest buildRequest(final List<Option> requestOptions) {
