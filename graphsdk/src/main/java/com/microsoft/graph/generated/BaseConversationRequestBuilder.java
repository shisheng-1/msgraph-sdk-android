...
public class BaseConversationRequestBuilder extends BaseRequestBuilder implements IBaseConversationRequestBuilder {
     ...
     */
    public BaseConversationRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IConversationRequest buildRequest(final List<Option> requestOptions) {
