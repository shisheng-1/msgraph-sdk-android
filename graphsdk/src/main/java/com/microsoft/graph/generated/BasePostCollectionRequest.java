...
/**
 * The class for the Base Post Collection Request.
 */
public class BasePostCollectionRequest extends BaseCollectionRequest<BasePostCollectionResponse, IPostCollectionPage> implements IBasePostCollectionRequest {
     ...
     */
    public BasePostCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, BasePostCollectionResponse.class, IPostCollectionPage.class);
    }
    ...
    public IPostCollectionPage get() throws ClientException {
        final BasePostCollectionResponse response = send();
    ...
    public IPostCollectionPage buildFromResponse(final BasePostCollectionResponse response) {
