...
public class BaseWorkbookFunctionsImCosRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsImCosRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
     ...
     * @return The IWorkbookFunctionsImCosRequest instance
     */
    public IWorkbookFunctionsImCosRequest buildRequest(final List<Option> requestOptions) {
