...
public class BaseOnenoteSectionCopyToNotebookRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseOnenoteSectionCopyToNotebookRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String id, final String siteCollectionId, final String siteId, final String groupId, final String renameAs) {
