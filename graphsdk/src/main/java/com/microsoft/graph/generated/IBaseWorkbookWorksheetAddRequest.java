...
/**
 * The interface for the Base Workbook Worksheet Add Request.
 */
public interface IBaseWorkbookWorksheetAddRequest {

    void post(final ICallback<WorkbookWorksheet> callback);
