...
public class BaseOutlookCategoryCollectionRequestBuilder extends BaseRequestBuilder implements IBaseOutlookCategoryCollectionRequestBuilder {
     ...
     */
    public BaseOutlookCategoryCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
    ...
    public IOutlookCategoryCollectionRequest buildRequest(final java.util.List<Option> requestOptions) {
