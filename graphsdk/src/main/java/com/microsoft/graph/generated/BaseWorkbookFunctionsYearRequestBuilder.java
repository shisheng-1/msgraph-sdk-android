...
public class BaseWorkbookFunctionsYearRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsYearRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement serialNumber) {
     ...
     * @return The IWorkbookFunctionsYearRequest instance
     */
    public IWorkbookFunctionsYearRequest buildRequest(final List<Option> requestOptions) {
