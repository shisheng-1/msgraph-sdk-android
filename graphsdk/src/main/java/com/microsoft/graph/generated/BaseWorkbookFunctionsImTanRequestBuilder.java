...
public class BaseWorkbookFunctionsImTanRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsImTanRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
     ...
     * @return The IWorkbookFunctionsImTanRequest instance
     */
    public IWorkbookFunctionsImTanRequest buildRequest(final List<Option> requestOptions) {
