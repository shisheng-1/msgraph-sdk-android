...
/**
 * The interface for the Base Report Root Get Share Point Site Usage Site Counts Request Builder.
 */
public interface IBaseReportRootGetSharePointSiteUsageSiteCountsRequestBuilder extends IRequestBuilder {
     ...
     * @return The IReportRootGetSharePointSiteUsageSiteCountsRequest instance
     */
    IReportRootGetSharePointSiteUsageSiteCountsRequest buildRequest(final java.util.List<Option> requestOptions);
}
