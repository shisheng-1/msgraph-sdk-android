...
public class BaseWorkbookFunctionsFvscheduleRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsFvscheduleRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement principal, final com.google.gson.JsonElement schedule) {
     ...
     * @return The IWorkbookFunctionsFvscheduleRequest instance
     */
    public IWorkbookFunctionsFvscheduleRequest buildRequest(final List<Option> requestOptions) {
