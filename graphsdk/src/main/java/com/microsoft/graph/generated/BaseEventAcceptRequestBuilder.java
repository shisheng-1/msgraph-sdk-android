 ...
 */
public class BaseEventAcceptRequestBuilder extends BaseRequestBuilder {
    ...
    public IEventAcceptRequest buildRequest(final List<Option> options) {
        return new EventAcceptRequest(getRequestUrl(), getClient(), options, mComment, mSendResponse);
    }
}
