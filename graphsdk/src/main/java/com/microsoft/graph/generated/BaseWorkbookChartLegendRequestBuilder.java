...
public class BaseWorkbookChartLegendRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartLegendRequestBuilder {
     ...
     */
    public BaseWorkbookChartLegendRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookChartLegendRequest buildRequest(final List<Option> requestOptions) {
