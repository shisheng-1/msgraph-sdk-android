...
/**
 * The class for the Base Workbook Range View Collection Request.
 */
public class BaseWorkbookRangeViewCollectionRequest extends BaseCollectionRequest<BaseWorkbookRangeViewCollectionResponse, IWorkbookRangeViewCollectionPage> implements IBaseWorkbookRangeViewCollectionRequest {
     ...
     */
    public BaseWorkbookRangeViewCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<Option> requestOptions) {
    ...
    public IWorkbookRangeViewCollectionPage get() throws ClientException {
        final BaseWorkbookRangeViewCollectionResponse response = send();
    ...
    public IWorkbookRangeViewCollectionPage buildFromResponse(final BaseWorkbookRangeViewCollectionResponse response) {
