 ...
 */
public class BaseWorkbookFunctionsTrueRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsTrueRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookFunctionsTrueRequest instance
     */
    public IWorkbookFunctionsTrueRequest buildRequest(final List<Option> requestOptions) {
