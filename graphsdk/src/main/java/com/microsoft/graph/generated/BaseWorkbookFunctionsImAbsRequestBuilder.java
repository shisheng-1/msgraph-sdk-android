...
public class BaseWorkbookFunctionsImAbsRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsImAbsRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
     ...
     * @return The IWorkbookFunctionsImAbsRequest instance
     */
    public IWorkbookFunctionsImAbsRequest buildRequest(final List<Option> requestOptions) {
