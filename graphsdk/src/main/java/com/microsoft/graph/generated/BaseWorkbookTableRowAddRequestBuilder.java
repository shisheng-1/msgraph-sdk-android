...
public class BaseWorkbookTableRowAddRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookTableRowAddRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final Integer index, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookTableRowAddRequest instance
     */
    public IWorkbookTableRowAddRequest buildRequest(final List<Option> requestOptions) {
