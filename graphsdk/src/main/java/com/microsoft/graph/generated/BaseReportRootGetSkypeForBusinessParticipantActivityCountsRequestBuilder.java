...
/**
 * The class for the Base Report Root Get Skype For Business Participant Activity Counts Request Builder.
 */
public class BaseReportRootGetSkypeForBusinessParticipantActivityCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetSkypeForBusinessParticipantActivityCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetSkypeForBusinessParticipantActivityCountsRequest instance
     */
    public IReportRootGetSkypeForBusinessParticipantActivityCountsRequest buildRequest(final java.util.List<Option> requestOptions) {
