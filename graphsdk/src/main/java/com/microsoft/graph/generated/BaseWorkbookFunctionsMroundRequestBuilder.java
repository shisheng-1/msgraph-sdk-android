...
public class BaseWorkbookFunctionsMroundRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsMroundRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number, final com.google.gson.JsonElement multiple) {
     ...
     * @return The IWorkbookFunctionsMroundRequest instance
     */
    public IWorkbookFunctionsMroundRequest buildRequest(final List<Option> requestOptions) {
