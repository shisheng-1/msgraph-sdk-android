...
public class BaseWorkbookFunctionsAcosRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsAcosRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
     ...
     * @return The IWorkbookFunctionsAcosRequest instance
     */
    public IWorkbookFunctionsAcosRequest buildRequest(final List<Option> requestOptions) {
