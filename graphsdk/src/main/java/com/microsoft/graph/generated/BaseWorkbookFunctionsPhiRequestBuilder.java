...
public class BaseWorkbookFunctionsPhiRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsPhiRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement x) {
     ...
     * @return The IWorkbookFunctionsPhiRequest instance
     */
    public IWorkbookFunctionsPhiRequest buildRequest(final List<Option> requestOptions) {
