...
public class BaseWorkbookFunctionsVarPARequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsVarPARequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsVarPARequest instance
     */
    public IWorkbookFunctionsVarPARequest buildRequest(final List<Option> requestOptions) {
