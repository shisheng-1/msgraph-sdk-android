...
public class BaseWorkbookFunctionsRowsRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsRowsRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement array) {
     ...
     * @return The IWorkbookFunctionsRowsRequest instance
     */
    public IWorkbookFunctionsRowsRequest buildRequest(final List<Option> requestOptions) {
