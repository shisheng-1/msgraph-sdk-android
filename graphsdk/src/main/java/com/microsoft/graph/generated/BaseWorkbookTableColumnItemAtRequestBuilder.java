...
public class BaseWorkbookTableColumnItemAtRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookTableColumnItemAtRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final Integer index) {
     ...
     * @return The IWorkbookTableColumnItemAtRequest instance
     */
    public IWorkbookTableColumnItemAtRequest buildRequest(final List<Option> requestOptions) {
