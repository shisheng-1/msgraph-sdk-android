...
public interface IBaseEducationClassRequestBuilder extends IRequestBuilder {
     ...
     */
    IEducationClassRequest buildRequest(final java.util.List<Option> requestOptions);
    ...
    IEducationUserWithReferenceRequestBuilder getMembers(final String id);

    IEducationUserCollectionWithReferencesRequestBuilder getTeachers();

    IEducationUserWithReferenceRequestBuilder getTeachers(final String id);
