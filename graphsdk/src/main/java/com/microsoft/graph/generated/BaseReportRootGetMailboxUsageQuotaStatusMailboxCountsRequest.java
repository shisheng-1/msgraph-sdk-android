...
/**
 * The class for the Base Report Root Get Mailbox Usage Quota Status Mailbox Counts Request.
 */
public class BaseReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest extends BaseRequest implements IBaseReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest {
     ...
     */
    public BaseReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
