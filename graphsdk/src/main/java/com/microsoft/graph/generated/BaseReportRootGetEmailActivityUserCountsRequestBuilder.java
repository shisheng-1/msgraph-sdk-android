...
public class BaseReportRootGetEmailActivityUserCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetEmailActivityUserCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetEmailActivityUserCountsRequest instance
     */
    public IReportRootGetEmailActivityUserCountsRequest buildRequest(final java.util.List<Option> requestOptions) {
