...
public class BaseWorkbookFunctionsImDivRequest extends BaseRequest implements IBaseWorkbookFunctionsImDivRequest {
    protected final WorkbookFunctionsImDivBody mBody;
     ...
     */
    public BaseWorkbookFunctionsImDivRequest(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        mBody = new WorkbookFunctionsImDivBody();
    }
