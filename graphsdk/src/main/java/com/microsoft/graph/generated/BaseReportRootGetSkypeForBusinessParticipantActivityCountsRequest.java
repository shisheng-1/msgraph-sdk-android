...
/**
 * The class for the Base Report Root Get Skype For Business Participant Activity Counts Request.
 */
public class BaseReportRootGetSkypeForBusinessParticipantActivityCountsRequest extends BaseRequest implements IBaseReportRootGetSkypeForBusinessParticipantActivityCountsRequest {
     ...
     */
    public BaseReportRootGetSkypeForBusinessParticipantActivityCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
