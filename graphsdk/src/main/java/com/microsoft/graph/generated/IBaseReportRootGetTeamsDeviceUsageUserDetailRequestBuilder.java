...
/**
 * The interface for the Base Report Root Get Teams Device Usage User Detail Request Builder.
 */
public interface IBaseReportRootGetTeamsDeviceUsageUserDetailRequestBuilder extends IRequestBuilder {
     ...
     * @return The IReportRootGetTeamsDeviceUsageUserDetailRequest instance
     */
    IReportRootGetTeamsDeviceUsageUserDetailRequest buildRequest(final java.util.List<Option> requestOptions);
}
