...
public class BaseWorkbookNamedItemRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookNamedItemRequestBuilder {
     ...
     */
    public BaseWorkbookNamedItemRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookNamedItemRequest buildRequest(final List<Option> requestOptions) {
