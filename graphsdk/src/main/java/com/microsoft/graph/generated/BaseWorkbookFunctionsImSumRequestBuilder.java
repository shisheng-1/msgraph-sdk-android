...
public class BaseWorkbookFunctionsImSumRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsImSumRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsImSumRequest instance
     */
    public IWorkbookFunctionsImSumRequest buildRequest(final List<Option> requestOptions) {
