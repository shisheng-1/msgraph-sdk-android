...
public class BaseWorkbookWorksheetCellRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookWorksheetCellRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final Integer row, final Integer column) {
     ...
     * @return The IWorkbookWorksheetCellRequest instance
     */
    public IWorkbookWorksheetCellRequest buildRequest(final List<Option> requestOptions) {
