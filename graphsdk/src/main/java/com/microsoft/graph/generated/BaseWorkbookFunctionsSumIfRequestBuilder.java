...
public class BaseWorkbookFunctionsSumIfRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsSumIfRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement range, final com.google.gson.JsonElement criteria, final com.google.gson.JsonElement sumRange) {
     ...
     * @return The IWorkbookFunctionsSumIfRequest instance
     */
    public IWorkbookFunctionsSumIfRequest buildRequest(final List<Option> requestOptions) {
