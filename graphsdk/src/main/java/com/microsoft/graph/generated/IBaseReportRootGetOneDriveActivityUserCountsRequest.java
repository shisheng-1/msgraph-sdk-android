...
/**
 * The interface for the Base Report Root Get One Drive Activity User Counts Request.
 */
public interface IBaseReportRootGetOneDriveActivityUserCountsRequest {
     ...
     */
    IReportRootGetOneDriveActivityUserCountsRequest select(final String value);
     ...
     * @return The updated request
     */
    IReportRootGetOneDriveActivityUserCountsRequest expand(final String value);
