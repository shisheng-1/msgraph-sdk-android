...
public class BaseEducationUserCollectionReferenceRequestBuilder extends BaseRequestBuilder implements IBaseEducationUserCollectionReferenceRequestBuilder {
     ...
     */
    public BaseEducationUserCollectionReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
    ...
    public IEducationUserCollectionReferenceRequest buildRequest(final java.util.List<Option> requestOptions) {
