...
public class BaseWorkbookFunctionsDbcsRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsDbcsRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement text) {
     ...
     * @return The IWorkbookFunctionsDbcsRequest instance
     */
    public IWorkbookFunctionsDbcsRequest buildRequest(final List<Option> requestOptions) {
