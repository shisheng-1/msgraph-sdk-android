...
public class BaseWorkbookFunctionsIsNARequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsIsNARequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement value) {
     ...
     * @return The IWorkbookFunctionsIsNARequest instance
     */
    public IWorkbookFunctionsIsNARequest buildRequest(final List<Option> requestOptions) {
