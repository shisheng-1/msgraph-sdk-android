...
/**
 * The interface for the Base Report Root Get Email App Usage Apps User Counts Request Builder.
 */
public interface IBaseReportRootGetEmailAppUsageAppsUserCountsRequestBuilder extends IRequestBuilder {
     ...
     * @return The IReportRootGetEmailAppUsageAppsUserCountsRequest instance
     */
    IReportRootGetEmailAppUsageAppsUserCountsRequest buildRequest(final java.util.List<Option> requestOptions);
}
