...
public class BaseWorkbookFunctionsExpon_DistRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsExpon_DistRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement x, final com.google.gson.JsonElement lambda, final com.google.gson.JsonElement cumulative) {
     ...
     * @return The IWorkbookFunctionsExpon_DistRequest instance
     */
    public IWorkbookFunctionsExpon_DistRequest buildRequest(final List<Option> requestOptions) {
