...
public class BaseEducationClassCollectionWithReferencesRequestBuilder extends BaseRequestBuilder implements IBaseEducationClassCollectionWithReferencesRequestBuilder {
     ...
     */
    public BaseEducationClassCollectionWithReferencesRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
    ...
    public IEducationClassCollectionWithReferencesRequest buildRequest(final java.util.List<Option> requestOptions) {
