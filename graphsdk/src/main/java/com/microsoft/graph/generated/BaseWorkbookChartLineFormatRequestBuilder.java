...
public class BaseWorkbookChartLineFormatRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartLineFormatRequestBuilder {
     ...
     */
    public BaseWorkbookChartLineFormatRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookChartLineFormatRequest buildRequest(final List<Option> requestOptions) {
