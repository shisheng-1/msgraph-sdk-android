...
/**
 * The interface for the Base Workbook Functions Text Request Builder.
 */
public interface IBaseWorkbookFunctionsTextRequestBuilder extends IRequestBuilder {
     ...
     * @return The IWorkbookFunctionsTextRequest instance
     */
    IWorkbookFunctionsTextRequest buildRequest(final List<Option> requestOptions);
}
