...
public class BaseWorkbookWorksheetProtectionRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookWorksheetProtectionRequestBuilder {
     ...
     */
    public BaseWorkbookWorksheetProtectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookWorksheetProtectionRequest buildRequest(final List<Option> requestOptions) {
