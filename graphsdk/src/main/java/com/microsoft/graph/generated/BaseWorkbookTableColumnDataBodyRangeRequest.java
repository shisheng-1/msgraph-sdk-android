...
/**
 * The class for the Base Workbook Table Column Data Body Range Request.
 */
public class BaseWorkbookTableColumnDataBodyRangeRequest extends BaseRequest implements IBaseWorkbookTableColumnDataBodyRangeRequest {
     ...
     */
    public BaseWorkbookTableColumnDataBodyRangeRequest(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
