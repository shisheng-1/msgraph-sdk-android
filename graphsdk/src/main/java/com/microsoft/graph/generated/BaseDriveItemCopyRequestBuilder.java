 ...
 */
public class BaseDriveItemCopyRequestBuilder extends BaseRequestBuilder {
    ...
    public IDriveItemCopyRequest buildRequest(final List<Option> options) {
        return new DriveItemCopyRequest(getRequestUrl(), getClient(), options, mName, mParentReference);
    }
}
