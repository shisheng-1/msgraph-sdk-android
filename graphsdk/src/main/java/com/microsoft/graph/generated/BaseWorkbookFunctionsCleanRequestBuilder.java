...
public class BaseWorkbookFunctionsCleanRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsCleanRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement text) {
     ...
     * @return The IWorkbookFunctionsCleanRequest instance
     */
    public IWorkbookFunctionsCleanRequest buildRequest(final List<Option> requestOptions) {
