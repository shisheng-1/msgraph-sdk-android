...
public class BaseWorkbookWorksheetAddRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookWorksheetAddRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final String name) {
     ...
     * @return The IWorkbookWorksheetAddRequest instance
     */
    public IWorkbookWorksheetAddRequest buildRequest(final List<Option> requestOptions) {
