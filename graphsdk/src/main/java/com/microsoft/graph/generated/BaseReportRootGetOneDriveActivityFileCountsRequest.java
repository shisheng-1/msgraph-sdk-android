...
/**
 * The class for the Base Report Root Get One Drive Activity File Counts Request.
 */
public class BaseReportRootGetOneDriveActivityFileCountsRequest extends BaseRequest implements IBaseReportRootGetOneDriveActivityFileCountsRequest {
     ...
     */
    public BaseReportRootGetOneDriveActivityFileCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IReportRootGetOneDriveActivityFileCountsRequest select(final String value) {
     ...
     * @return The updated request
     */
    public IReportRootGetOneDriveActivityFileCountsRequest expand(final String value) {
