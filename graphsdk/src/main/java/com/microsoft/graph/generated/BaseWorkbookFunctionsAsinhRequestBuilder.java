...
public class BaseWorkbookFunctionsAsinhRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsAsinhRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
     ...
     * @return The IWorkbookFunctionsAsinhRequest instance
     */
    public IWorkbookFunctionsAsinhRequest buildRequest(final List<Option> requestOptions) {
