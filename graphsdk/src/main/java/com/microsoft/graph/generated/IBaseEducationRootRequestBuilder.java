...
public interface IBaseEducationRootRequestBuilder extends IRequestBuilder {
     ...
     */
    IEducationRootRequest buildRequest(final java.util.List<Option> requestOptions);

    IEducationClassCollectionRequestBuilder getClasses();

    IEducationClassRequestBuilder getClasses(final String id);

    IEducationSchoolCollectionRequestBuilder getSchools();

    IEducationSchoolRequestBuilder getSchools(final String id);

    IEducationUserCollectionRequestBuilder getUsers();

    IEducationUserRequestBuilder getUsers(final String id);
