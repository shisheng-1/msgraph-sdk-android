...
public class BaseWorkbookChartDataLabelFormatRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartDataLabelFormatRequestBuilder {
     ...
     */
    public BaseWorkbookChartDataLabelFormatRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookChartDataLabelFormatRequest buildRequest(final List<Option> requestOptions) {
