...
public class BaseWorkbookFunctionsRightRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsRightRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement text, final com.google.gson.JsonElement numChars) {
     ...
     * @return The IWorkbookFunctionsRightRequest instance
     */
    public IWorkbookFunctionsRightRequest buildRequest(final List<Option> requestOptions) {
