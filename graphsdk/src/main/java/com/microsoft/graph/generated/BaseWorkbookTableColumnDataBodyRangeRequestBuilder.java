...
public class BaseWorkbookTableColumnDataBodyRangeRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookTableColumnDataBodyRangeRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookTableColumnDataBodyRangeRequest instance
     */
    public IWorkbookTableColumnDataBodyRangeRequest buildRequest(final List<Option> requestOptions) {
