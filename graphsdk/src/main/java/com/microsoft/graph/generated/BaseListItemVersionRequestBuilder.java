...
public class BaseListItemVersionRequestBuilder extends BaseRequestBuilder implements IBaseListItemVersionRequestBuilder {
     ...
     */
    public BaseListItemVersionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IListItemVersionRequest buildRequest(final java.util.List<Option> requestOptions) {
    ...
    public IListItemVersionRestoreVersionRequestBuilder getRestoreVersion() {
