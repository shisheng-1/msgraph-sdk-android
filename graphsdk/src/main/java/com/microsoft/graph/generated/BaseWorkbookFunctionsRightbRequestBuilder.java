...
public class BaseWorkbookFunctionsRightbRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsRightbRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement text, final com.google.gson.JsonElement numBytes) {
     ...
     * @return The IWorkbookFunctionsRightbRequest instance
     */
    public IWorkbookFunctionsRightbRequest buildRequest(final List<Option> requestOptions) {
