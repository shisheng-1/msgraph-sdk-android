...
/**
 * The interface for the Base Report Root Get Share Point Site Usage Detail Request Builder.
 */
public interface IBaseReportRootGetSharePointSiteUsageDetailRequestBuilder extends IRequestBuilder {
     ...
     * @return The IReportRootGetSharePointSiteUsageDetailRequest instance
     */
    IReportRootGetSharePointSiteUsageDetailRequest buildRequest(final java.util.List<Option> requestOptions);
}
