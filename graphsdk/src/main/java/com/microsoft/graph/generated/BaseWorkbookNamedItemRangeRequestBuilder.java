...
public class BaseWorkbookNamedItemRangeRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookNamedItemRangeRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookNamedItemRangeRequest instance
     */
    public IWorkbookNamedItemRangeRequest buildRequest(final List<Option> requestOptions) {
