...
/**
 * The class for the Base Report Root Get One Drive Usage File Counts Request.
 */
public class BaseReportRootGetOneDriveUsageFileCountsRequest extends BaseRequest implements IBaseReportRootGetOneDriveUsageFileCountsRequest {
     ...
     */
    public BaseReportRootGetOneDriveUsageFileCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
    ...
    /**
     * Puts the ReportRootGetOneDriveUsageFileCounts
     *
     ...
     */
    public IReportRootGetOneDriveUsageFileCountsRequest select(final String value) {
     ...
     * @return The updated request
     */
    public IReportRootGetOneDriveUsageFileCountsRequest expand(final String value) {
