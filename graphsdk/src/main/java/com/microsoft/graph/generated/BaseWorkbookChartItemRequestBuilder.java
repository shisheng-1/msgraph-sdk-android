...
public class BaseWorkbookChartItemRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookChartItemRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final String name) {
     ...
     * @return The IWorkbookChartItemRequest instance
     */
    public IWorkbookChartItemRequest buildRequest(final List<Option> requestOptions) {
