...
public class BaseDirectoryRoleRequestBuilder extends BaseRequestBuilder implements IBaseDirectoryRoleRequestBuilder {
     ...
     */
    public BaseDirectoryRoleRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IDirectoryRoleRequest buildRequest(final List<Option> requestOptions) {
