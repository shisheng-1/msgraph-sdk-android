...
public class BaseWorkbookFunctionsDmaxRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsDmaxRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement database, final com.google.gson.JsonElement field, final com.google.gson.JsonElement criteria) {
     ...
     * @return The IWorkbookFunctionsDmaxRequest instance
     */
    public IWorkbookFunctionsDmaxRequest buildRequest(final List<Option> requestOptions) {
