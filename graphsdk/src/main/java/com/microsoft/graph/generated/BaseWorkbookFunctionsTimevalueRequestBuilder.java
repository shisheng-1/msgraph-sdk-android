...
public class BaseWorkbookFunctionsTimevalueRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsTimevalueRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement timeText) {
     ...
     * @return The IWorkbookFunctionsTimevalueRequest instance
     */
    public IWorkbookFunctionsTimevalueRequest buildRequest(final List<Option> requestOptions) {
