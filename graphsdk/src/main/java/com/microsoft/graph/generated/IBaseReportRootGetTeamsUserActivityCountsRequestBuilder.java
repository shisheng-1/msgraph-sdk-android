...
/**
 * The interface for the Base Report Root Get Teams User Activity Counts Request Builder.
 */
public interface IBaseReportRootGetTeamsUserActivityCountsRequestBuilder extends IRequestBuilder {
     ...
     * @return The IReportRootGetTeamsUserActivityCountsRequest instance
     */
    IReportRootGetTeamsUserActivityCountsRequest buildRequest(final java.util.List<Option> requestOptions);
}
