...
/**
 * The interface for the Base Workbook Functions Percent Rank_Inc Request Builder.
 */
public interface IBaseWorkbookFunctionsPercentRank_IncRequestBuilder extends IRequestBuilder {
     ...
     * @return The IWorkbookFunctionsPercentRank_IncRequest instance
     */
    IWorkbookFunctionsPercentRank_IncRequest buildRequest(final List<Option> requestOptions);
}
