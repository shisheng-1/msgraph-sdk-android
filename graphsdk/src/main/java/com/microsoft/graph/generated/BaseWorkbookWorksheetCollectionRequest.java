...
/**
 * The class for the Base Workbook Worksheet Collection Request.
 */
public class BaseWorkbookWorksheetCollectionRequest extends BaseCollectionRequest<BaseWorkbookWorksheetCollectionResponse, IWorkbookWorksheetCollectionPage> implements IBaseWorkbookWorksheetCollectionRequest {
     ...
     */
    public BaseWorkbookWorksheetCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseWorkbookWorksheetCollectionResponse.class, IWorkbookWorksheetCollectionPage.class);
    }
    ...
    public IWorkbookWorksheetCollectionPage get() throws ClientException {
        final BaseWorkbookWorksheetCollectionResponse response = send();
    ...
    public IWorkbookWorksheetCollectionPage buildFromResponse(final BaseWorkbookWorksheetCollectionResponse response) {
