...
public class BaseWorkbookFunctionsDollarFrRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsDollarFrRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement decimalDollar, final com.google.gson.JsonElement fraction) {
     ...
     * @return The IWorkbookFunctionsDollarFrRequest instance
     */
    public IWorkbookFunctionsDollarFrRequest buildRequest(final List<Option> requestOptions) {
