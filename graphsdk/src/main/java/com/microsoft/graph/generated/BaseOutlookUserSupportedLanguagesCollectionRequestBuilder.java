...
public class BaseOutlookUserSupportedLanguagesCollectionRequestBuilder extends BaseFunctionRequestBuilder implements IBaseOutlookUserSupportedLanguagesCollectionRequestBuilder {
     ...
     */
    public BaseOutlookUserSupportedLanguagesCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
    ...
    public IOutlookUserSupportedLanguagesCollectionRequest buildRequest(final java.util.List<Option> requestOptions) {
