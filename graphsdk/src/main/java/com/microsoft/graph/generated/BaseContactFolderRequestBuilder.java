...
public class BaseContactFolderRequestBuilder extends BaseRequestBuilder implements IBaseContactFolderRequestBuilder {
     ...
     */
    public BaseContactFolderRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options) {
     ...
     */
    public IContactFolderRequest buildRequest(final List<Option> options) {
        return new ContactFolderRequest(getRequestUrl(), getClient(), options);
    }
