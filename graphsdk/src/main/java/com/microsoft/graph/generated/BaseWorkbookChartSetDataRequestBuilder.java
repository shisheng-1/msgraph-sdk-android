...
public class BaseWorkbookChartSetDataRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookChartSetDataRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement sourceData, final String seriesBy) {
     ...
     * @return The IWorkbookChartSetDataRequest instance
     */
    public IWorkbookChartSetDataRequest buildRequest(final List<Option> requestOptions) {
