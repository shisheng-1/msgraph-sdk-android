...
/**
 * The class for the Base Workbook Functions Baht Text Request Builder.
 */
public class BaseWorkbookFunctionsBahtTextRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsBahtTextRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
     ...
     * @return The IWorkbookFunctionsBahtTextRequest instance
     */
    public IWorkbookFunctionsBahtTextRequest buildRequest(final List<Option> requestOptions) {
