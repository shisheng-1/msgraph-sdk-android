...
/**
 * The interface for the Base Report Root Get Share Point Site Usage File Counts Request Builder.
 */
public interface IBaseReportRootGetSharePointSiteUsageFileCountsRequestBuilder extends IRequestBuilder {
     ...
     * @return The IReportRootGetSharePointSiteUsageFileCountsRequest instance
     */
    IReportRootGetSharePointSiteUsageFileCountsRequest buildRequest(final java.util.List<Option> requestOptions);
}
