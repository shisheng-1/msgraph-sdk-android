...
/**
 * The class for the Base Workbook Range Row Request Builder.
 */
public class BaseWorkbookRangeRowRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookRangeRowRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final Integer row) {
     ...
     * @return The IWorkbookRangeRowRequest instance
     */
    public IWorkbookRangeRowRequest buildRequest(final List<Option> requestOptions) {
