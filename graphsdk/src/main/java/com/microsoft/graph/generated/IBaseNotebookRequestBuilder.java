...
public interface IBaseNotebookRequestBuilder extends IRequestBuilder {
    ...
    INotebookCopyNotebookRequestBuilder getCopyNotebook(final String groupId, final String renameAs, final String notebookFolder, final String siteCollectionId, final String siteId);
