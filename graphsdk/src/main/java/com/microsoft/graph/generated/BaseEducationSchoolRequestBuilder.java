...
public class BaseEducationSchoolRequestBuilder extends BaseRequestBuilder implements IBaseEducationSchoolRequestBuilder {
     ...
     */
    public BaseEducationSchoolRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IEducationSchoolRequest buildRequest(final java.util.List<Option> requestOptions) {
    ...
    public IEducationClassWithReferenceRequestBuilder getClasses(final String id) {
    ...
    public IEducationUserWithReferenceRequestBuilder getUsers(final String id) {
