...
public class BaseWorkbookFunctionsVar_SRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsVar_SRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsVar_SRequest instance
     */
    public IWorkbookFunctionsVar_SRequest buildRequest(final List<Option> requestOptions) {
