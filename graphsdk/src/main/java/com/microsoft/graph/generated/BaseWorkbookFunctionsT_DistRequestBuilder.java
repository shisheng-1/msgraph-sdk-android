...
public class BaseWorkbookFunctionsT_DistRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsT_DistRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement x, final com.google.gson.JsonElement degFreedom, final com.google.gson.JsonElement cumulative) {
     ...
     * @return The IWorkbookFunctionsT_DistRequest instance
     */
    public IWorkbookFunctionsT_DistRequest buildRequest(final List<Option> requestOptions) {
