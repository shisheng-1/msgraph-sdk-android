...
public class BaseWorkbookFunctionsDayRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsDayRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement serialNumber) {
     ...
     * @return The IWorkbookFunctionsDayRequest instance
     */
    public IWorkbookFunctionsDayRequest buildRequest(final List<Option> requestOptions) {
