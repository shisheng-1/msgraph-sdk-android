...
public class BaseReportRootGetSharePointSiteUsageFileCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetSharePointSiteUsageFileCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetSharePointSiteUsageFileCountsRequest instance
     */
    public IReportRootGetSharePointSiteUsageFileCountsRequest buildRequest(final java.util.List<Option> requestOptions) {
