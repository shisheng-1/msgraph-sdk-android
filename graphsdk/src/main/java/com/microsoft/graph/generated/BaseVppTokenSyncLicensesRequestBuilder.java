...
public class BaseVppTokenSyncLicensesRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseVppTokenSyncLicensesRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     * @return The IVppTokenSyncLicensesRequest instance
     */
    public IVppTokenSyncLicensesRequest buildRequest(final java.util.List<Option> requestOptions) {
