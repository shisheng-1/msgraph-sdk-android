...
public class BaseWorkbookFunctionsFactDoubleRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsFactDoubleRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
     ...
     * @return The IWorkbookFunctionsFactDoubleRequest instance
     */
    public IWorkbookFunctionsFactDoubleRequest buildRequest(final List<Option> requestOptions) {
