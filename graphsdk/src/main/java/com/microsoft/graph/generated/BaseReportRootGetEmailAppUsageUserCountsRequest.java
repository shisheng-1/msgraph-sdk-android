...
/**
 * The class for the Base Report Root Get Email App Usage User Counts Request.
 */
public class BaseReportRootGetEmailAppUsageUserCountsRequest extends BaseRequest implements IBaseReportRootGetEmailAppUsageUserCountsRequest {
     ...
     */
    public BaseReportRootGetEmailAppUsageUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
