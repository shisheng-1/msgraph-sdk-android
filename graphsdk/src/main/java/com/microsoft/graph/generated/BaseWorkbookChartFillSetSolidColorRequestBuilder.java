...
public class BaseWorkbookChartFillSetSolidColorRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookChartFillSetSolidColorRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final String color) {
     ...
     * @return The IWorkbookChartFillSetSolidColorRequest instance
     */
    public IWorkbookChartFillSetSolidColorRequest buildRequest(final List<Option> requestOptions) {
