...
public class BaseEducationSchoolCollectionReferenceRequestBuilder extends BaseRequestBuilder implements IBaseEducationSchoolCollectionReferenceRequestBuilder {
     ...
     */
    public BaseEducationSchoolCollectionReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
    ...
    public IEducationSchoolCollectionReferenceRequest buildRequest(final java.util.List<Option> requestOptions) {
