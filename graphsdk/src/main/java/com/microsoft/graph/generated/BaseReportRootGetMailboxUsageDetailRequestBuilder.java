...
public class BaseReportRootGetMailboxUsageDetailRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetMailboxUsageDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetMailboxUsageDetailRequest instance
     */
    public IReportRootGetMailboxUsageDetailRequest buildRequest(final java.util.List<Option> requestOptions) {
