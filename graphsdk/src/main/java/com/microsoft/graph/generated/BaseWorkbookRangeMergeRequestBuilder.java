...
public class BaseWorkbookRangeMergeRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookRangeMergeRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final Boolean across) {
     ...
     * @return The IWorkbookRangeMergeRequest instance
     */
    public IWorkbookRangeMergeRequest buildRequest(final List<Option> requestOptions) {
