...
public class BaseListItemVersionCollectionRequestBuilder extends BaseRequestBuilder implements IBaseListItemVersionCollectionRequestBuilder {
     ...
     */
    public BaseListItemVersionCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
    ...
    public IListItemVersionCollectionRequest buildRequest(final java.util.List<Option> requestOptions) {
