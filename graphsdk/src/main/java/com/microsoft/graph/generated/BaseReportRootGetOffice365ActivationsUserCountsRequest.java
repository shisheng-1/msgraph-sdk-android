...
/**
 * The class for the Base Report Root Get Office365Activations User Counts Request.
 */
public class BaseReportRootGetOffice365ActivationsUserCountsRequest extends BaseRequest implements IBaseReportRootGetOffice365ActivationsUserCountsRequest {
     ...
     */
    public BaseReportRootGetOffice365ActivationsUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootGetOffice365ActivationsUserCounts
    ...
    /**
     * Puts the ReportRootGetOffice365ActivationsUserCounts
     *
     ...
     */
    public IReportRootGetOffice365ActivationsUserCountsRequest select(final String value) {
     ...
     * @return The updated request
     */
    public IReportRootGetOffice365ActivationsUserCountsRequest expand(final String value) {
