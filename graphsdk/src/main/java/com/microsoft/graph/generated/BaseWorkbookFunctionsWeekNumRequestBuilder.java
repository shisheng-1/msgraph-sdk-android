...
public class BaseWorkbookFunctionsWeekNumRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsWeekNumRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement serialNumber, final com.google.gson.JsonElement returnType) {
     ...
     * @return The IWorkbookFunctionsWeekNumRequest instance
     */
    public IWorkbookFunctionsWeekNumRequest buildRequest(final List<Option> requestOptions) {
