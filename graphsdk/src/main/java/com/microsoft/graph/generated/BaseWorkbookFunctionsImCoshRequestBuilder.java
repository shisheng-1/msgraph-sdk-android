...
public class BaseWorkbookFunctionsImCoshRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsImCoshRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
     ...
     * @return The IWorkbookFunctionsImCoshRequest instance
     */
    public IWorkbookFunctionsImCoshRequest buildRequest(final List<Option> requestOptions) {
