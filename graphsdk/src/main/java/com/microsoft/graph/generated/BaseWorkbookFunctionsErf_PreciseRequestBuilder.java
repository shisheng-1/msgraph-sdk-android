...
public class BaseWorkbookFunctionsErf_PreciseRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsErf_PreciseRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement x) {
     ...
     * @return The IWorkbookFunctionsErf_PreciseRequest instance
     */
    public IWorkbookFunctionsErf_PreciseRequest buildRequest(final List<Option> requestOptions) {
