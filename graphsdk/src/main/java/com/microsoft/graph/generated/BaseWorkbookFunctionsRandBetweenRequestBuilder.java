...
public class BaseWorkbookFunctionsRandBetweenRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsRandBetweenRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement bottom, final com.google.gson.JsonElement top) {
     ...
     * @return The IWorkbookFunctionsRandBetweenRequest instance
     */
    public IWorkbookFunctionsRandBetweenRequest buildRequest(final List<Option> requestOptions) {
