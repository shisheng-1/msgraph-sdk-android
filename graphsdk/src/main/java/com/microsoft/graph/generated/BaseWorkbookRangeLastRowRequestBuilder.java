...
public class BaseWorkbookRangeLastRowRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookRangeLastRowRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookRangeLastRowRequest instance
     */
    public IWorkbookRangeLastRowRequest buildRequest(final List<Option> requestOptions) {
