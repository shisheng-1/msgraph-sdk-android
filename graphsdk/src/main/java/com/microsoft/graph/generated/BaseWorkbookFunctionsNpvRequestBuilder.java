...
public class BaseWorkbookFunctionsNpvRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsNpvRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement rate, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsNpvRequest instance
     */
    public IWorkbookFunctionsNpvRequest buildRequest(final List<Option> requestOptions) {
