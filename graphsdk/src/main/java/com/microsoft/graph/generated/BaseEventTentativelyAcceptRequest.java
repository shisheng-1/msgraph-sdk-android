...
public class BaseEventTentativelyAcceptRequest extends BaseRequest implements IBaseEventTentativelyAcceptRequest {
     ...
     */
    public BaseEventTentativelyAcceptRequest(final String requestUrl, final IBaseClient client, final List<Option> options, final String comment, final Boolean sendResponse) {
