...
/**
 * The class for the Base Message Rule Request.
 */
public class BaseMessageRuleRequest extends BaseRequest implements IBaseMessageRuleRequest {
     ...
     */
    public BaseMessageRuleRequest(final String requestUrl,
