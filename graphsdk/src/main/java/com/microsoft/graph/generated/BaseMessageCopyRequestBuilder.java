...
public class BaseMessageCopyRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseMessageCopyRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final String destinationId) {
     ...
     * @return The IMessageCopyRequest instance
     */
    public IMessageCopyRequest buildRequest(final List<Option> requestOptions) {
