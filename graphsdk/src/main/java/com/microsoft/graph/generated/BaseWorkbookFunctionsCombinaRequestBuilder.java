...
public class BaseWorkbookFunctionsCombinaRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsCombinaRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number, final com.google.gson.JsonElement numberChosen) {
     ...
     * @return The IWorkbookFunctionsCombinaRequest instance
     */
    public IWorkbookFunctionsCombinaRequest buildRequest(final List<Option> requestOptions) {
