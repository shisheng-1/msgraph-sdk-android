...
public class BaseWorkbookFunctionsSheetsRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsSheetsRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement reference) {
     ...
     * @return The IWorkbookFunctionsSheetsRequest instance
     */
    public IWorkbookFunctionsSheetsRequest buildRequest(final List<Option> requestOptions) {
