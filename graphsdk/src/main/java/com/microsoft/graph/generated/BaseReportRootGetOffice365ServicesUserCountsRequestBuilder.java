...
public class BaseReportRootGetOffice365ServicesUserCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetOffice365ServicesUserCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetOffice365ServicesUserCountsRequest instance
     */
    public IReportRootGetOffice365ServicesUserCountsRequest buildRequest(final java.util.List<Option> requestOptions) {
