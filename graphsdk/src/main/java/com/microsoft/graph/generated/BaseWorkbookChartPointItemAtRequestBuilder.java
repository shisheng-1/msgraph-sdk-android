...
public class BaseWorkbookChartPointItemAtRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookChartPointItemAtRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final Integer index) {
     ...
     * @return The IWorkbookChartPointItemAtRequest instance
     */
    public IWorkbookChartPointItemAtRequest buildRequest(final List<Option> requestOptions) {
