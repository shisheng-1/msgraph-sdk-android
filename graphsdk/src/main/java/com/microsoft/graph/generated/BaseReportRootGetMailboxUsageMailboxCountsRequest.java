...
/**
 * The class for the Base Report Root Get Mailbox Usage Mailbox Counts Request.
 */
public class BaseReportRootGetMailboxUsageMailboxCountsRequest extends BaseRequest implements IBaseReportRootGetMailboxUsageMailboxCountsRequest {
     ...
     */
    public BaseReportRootGetMailboxUsageMailboxCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
