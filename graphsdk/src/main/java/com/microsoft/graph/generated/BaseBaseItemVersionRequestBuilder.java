...
public class BaseBaseItemVersionRequestBuilder extends BaseRequestBuilder implements IBaseBaseItemVersionRequestBuilder {
     ...
     */
    public BaseBaseItemVersionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IBaseItemVersionRequest buildRequest(final java.util.List<Option> requestOptions) {
