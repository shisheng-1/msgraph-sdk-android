...
public class BaseEventTentativelyAcceptRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseEventTentativelyAcceptRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final String comment, final Boolean sendResponse) {
     ...
     * @return The IEventTentativelyAcceptRequest instance
     */
    public IEventTentativelyAcceptRequest buildRequest(final List<Option> requestOptions) {
