 ...
 */
public class BaseWorkbookWorksheetProtectionUnprotectRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookWorksheetProtectionUnprotectRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookWorksheetProtectionUnprotectRequest instance
     */
    public IWorkbookWorksheetProtectionUnprotectRequest buildRequest(final List<Option> requestOptions) {
