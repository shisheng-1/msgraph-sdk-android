...
public class BaseWorkbookFunctionsIsEvenRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsIsEvenRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
     ...
     * @return The IWorkbookFunctionsIsEvenRequest instance
     */
    public IWorkbookFunctionsIsEvenRequest buildRequest(final List<Option> requestOptions) {
