...
public class BaseWorkbookFunctionsRadiansRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsRadiansRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement angle) {
     ...
     * @return The IWorkbookFunctionsRadiansRequest instance
     */
    public IWorkbookFunctionsRadiansRequest buildRequest(final List<Option> requestOptions) {
