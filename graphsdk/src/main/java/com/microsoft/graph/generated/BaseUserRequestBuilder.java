...
public class BaseUserRequestBuilder extends BaseRequestBuilder implements IBaseUserRequestBuilder {
     ...
     */
    public BaseUserRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options) {
     ...
     */
    public IUserRequest buildRequest(final List<Option> options) {
        return new UserRequest(getRequestUrl(), getClient(), options);
    }
