...
public class BaseWorkbookFunctionsChiSq_Dist_RTRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsChiSq_Dist_RTRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement x, final com.google.gson.JsonElement degFreedom) {
     ...
     * @return The IWorkbookFunctionsChiSq_Dist_RTRequest instance
     */
    public IWorkbookFunctionsChiSq_Dist_RTRequest buildRequest(final List<Option> requestOptions) {
