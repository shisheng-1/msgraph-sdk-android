...
public class BaseWorkbookFunctionsCschRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsCschRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
     ...
     * @return The IWorkbookFunctionsCschRequest instance
     */
    public IWorkbookFunctionsCschRequest buildRequest(final List<Option> requestOptions) {
