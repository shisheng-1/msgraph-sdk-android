...
public class BaseWorkbookRangeSortApplyRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookRangeSortApplyRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final List<WorkbookSortField> fields, final Boolean matchCase, final Boolean hasHeaders, final String orientation, final String method) {
     ...
     * @return The IWorkbookRangeSortApplyRequest instance
     */
    public IWorkbookRangeSortApplyRequest buildRequest(final List<Option> requestOptions) {
