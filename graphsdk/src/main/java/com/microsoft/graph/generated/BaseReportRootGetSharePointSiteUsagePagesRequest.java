...
/**
 * The class for the Base Report Root Get Share Point Site Usage Pages Request.
 */
public class BaseReportRootGetSharePointSiteUsagePagesRequest extends BaseRequest implements IBaseReportRootGetSharePointSiteUsagePagesRequest {
     ...
     */
    public BaseReportRootGetSharePointSiteUsagePagesRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
