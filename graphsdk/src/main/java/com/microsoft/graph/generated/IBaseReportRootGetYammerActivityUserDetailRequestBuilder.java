...
/**
 * The interface for the Base Report Root Get Yammer Activity User Detail Request Builder.
 */
public interface IBaseReportRootGetYammerActivityUserDetailRequestBuilder extends IRequestBuilder {
     ...
     * @return The IReportRootGetYammerActivityUserDetailRequest instance
     */
    IReportRootGetYammerActivityUserDetailRequest buildRequest(final java.util.List<Option> requestOptions);
}
