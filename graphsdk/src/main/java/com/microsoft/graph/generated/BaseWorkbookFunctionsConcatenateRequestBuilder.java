...
public class BaseWorkbookFunctionsConcatenateRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsConcatenateRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsConcatenateRequest instance
     */
    public IWorkbookFunctionsConcatenateRequest buildRequest(final List<Option> requestOptions) {
