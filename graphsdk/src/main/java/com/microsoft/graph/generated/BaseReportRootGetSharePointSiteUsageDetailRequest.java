...
/**
 * The class for the Base Report Root Get Share Point Site Usage Detail Request.
 */
public class BaseReportRootGetSharePointSiteUsageDetailRequest extends BaseRequest implements IBaseReportRootGetSharePointSiteUsageDetailRequest {
     ...
     */
    public BaseReportRootGetSharePointSiteUsageDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IReportRootGetSharePointSiteUsageDetailRequest select(final String value) {
     ...
     * @return The updated request
     */
    public IReportRootGetSharePointSiteUsageDetailRequest expand(final String value) {
