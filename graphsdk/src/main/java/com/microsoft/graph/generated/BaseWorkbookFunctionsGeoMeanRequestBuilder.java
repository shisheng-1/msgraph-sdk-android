...
public class BaseWorkbookFunctionsGeoMeanRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsGeoMeanRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsGeoMeanRequest instance
     */
    public IWorkbookFunctionsGeoMeanRequest buildRequest(final List<Option> requestOptions) {
