...
public class BaseWorkbookFunctionsTbillPriceRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsTbillPriceRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement settlement, final com.google.gson.JsonElement maturity, final com.google.gson.JsonElement discount) {
     ...
     * @return The IWorkbookFunctionsTbillPriceRequest instance
     */
    public IWorkbookFunctionsTbillPriceRequest buildRequest(final List<Option> requestOptions) {
