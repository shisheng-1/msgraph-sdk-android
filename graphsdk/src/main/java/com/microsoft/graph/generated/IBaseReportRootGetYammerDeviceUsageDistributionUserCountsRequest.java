...
/**
 * The interface for the Base Report Root Get Yammer Device Usage Distribution User Counts Request.
 */
public interface IBaseReportRootGetYammerDeviceUsageDistributionUserCountsRequest {
     ...
     */
    IReportRootGetYammerDeviceUsageDistributionUserCountsRequest select(final String value);
     ...
     * @return The updated request
     */
    IReportRootGetYammerDeviceUsageDistributionUserCountsRequest expand(final String value);
