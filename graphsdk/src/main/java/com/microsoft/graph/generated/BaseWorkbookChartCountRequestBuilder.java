...
public class BaseWorkbookChartCountRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookChartCountRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookChartCountRequest instance
     */
    public IWorkbookChartCountRequest buildRequest(final List<Option> requestOptions) {
