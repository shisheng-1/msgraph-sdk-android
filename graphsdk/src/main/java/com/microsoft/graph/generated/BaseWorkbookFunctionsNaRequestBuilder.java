 ...
 */
public class BaseWorkbookFunctionsNaRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsNaRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookFunctionsNaRequest instance
     */
    public IWorkbookFunctionsNaRequest buildRequest(final List<Option> requestOptions) {
