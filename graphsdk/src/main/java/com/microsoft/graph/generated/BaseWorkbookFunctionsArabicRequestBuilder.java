...
public class BaseWorkbookFunctionsArabicRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsArabicRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement text) {
     ...
     * @return The IWorkbookFunctionsArabicRequest instance
     */
    public IWorkbookFunctionsArabicRequest buildRequest(final List<Option> requestOptions) {
