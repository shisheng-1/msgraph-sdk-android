...
public class BaseEducationOrganizationRequestBuilder extends BaseRequestBuilder implements IBaseEducationOrganizationRequestBuilder {
     ...
     */
    public BaseEducationOrganizationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IEducationOrganizationRequest buildRequest(final java.util.List<Option> requestOptions) {
