...
/**
 * The interface for the Base Report Root Get Yammer Groups Activity Group Counts Request Builder.
 */
public interface IBaseReportRootGetYammerGroupsActivityGroupCountsRequestBuilder extends IRequestBuilder {
     ...
     * @return The IReportRootGetYammerGroupsActivityGroupCountsRequest instance
     */
    IReportRootGetYammerGroupsActivityGroupCountsRequest buildRequest(final java.util.List<Option> requestOptions);
}
