...
public class BaseWorkbookFunctionsEvenRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsEvenRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
     ...
     * @return The IWorkbookFunctionsEvenRequest instance
     */
    public IWorkbookFunctionsEvenRequest buildRequest(final List<Option> requestOptions) {
