...
public class BaseWorkbookFunctionsIsErrorRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsIsErrorRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement value) {
     ...
     * @return The IWorkbookFunctionsIsErrorRequest instance
     */
    public IWorkbookFunctionsIsErrorRequest buildRequest(final List<Option> requestOptions) {
