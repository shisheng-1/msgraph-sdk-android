...
public class BaseWorkbookFilterApplyBottomItemsFilterRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFilterApplyBottomItemsFilterRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final Integer count) {
     ...
     * @return The IWorkbookFilterApplyBottomItemsFilterRequest instance
     */
    public IWorkbookFilterApplyBottomItemsFilterRequest buildRequest(final List<Option> requestOptions) {
