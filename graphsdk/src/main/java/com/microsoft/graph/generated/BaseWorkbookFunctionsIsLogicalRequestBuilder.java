...
public class BaseWorkbookFunctionsIsLogicalRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsIsLogicalRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement value) {
     ...
     * @return The IWorkbookFunctionsIsLogicalRequest instance
     */
    public IWorkbookFunctionsIsLogicalRequest buildRequest(final List<Option> requestOptions) {
