...
public class BaseWorkbookFunctionsSumSqRequest extends BaseRequest implements IBaseWorkbookFunctionsSumSqRequest {
    protected final WorkbookFunctionsSumSqBody mBody;
     ...
     */
    public BaseWorkbookFunctionsSumSqRequest(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        mBody = new WorkbookFunctionsSumSqBody();
    }
