...
public class BaseWorkbookChartAreaFormatRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartAreaFormatRequestBuilder {
     ...
     */
    public BaseWorkbookChartAreaFormatRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookChartAreaFormatRequest buildRequest(final List<Option> requestOptions) {
