...
/**
 * The class for the Base Workbook Functions Min ARequest Builder.
 */
public class BaseWorkbookFunctionsMinARequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsMinARequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsMinARequest instance
     */
    public IWorkbookFunctionsMinARequest buildRequest(final List<Option> requestOptions) {
