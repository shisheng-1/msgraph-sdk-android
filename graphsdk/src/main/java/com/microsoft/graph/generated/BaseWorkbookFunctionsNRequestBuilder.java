...
public class BaseWorkbookFunctionsNRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsNRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement value) {
     ...
     * @return The IWorkbookFunctionsNRequest instance
     */
    public IWorkbookFunctionsNRequest buildRequest(final List<Option> requestOptions) {
