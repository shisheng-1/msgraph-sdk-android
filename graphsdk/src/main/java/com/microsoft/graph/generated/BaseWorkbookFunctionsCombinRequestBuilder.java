...
public class BaseWorkbookFunctionsCombinRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsCombinRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number, final com.google.gson.JsonElement numberChosen) {
     ...
     * @return The IWorkbookFunctionsCombinRequest instance
     */
    public IWorkbookFunctionsCombinRequest buildRequest(final List<Option> requestOptions) {
