...
public class BaseWorkbookFunctionsStDevARequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsStDevARequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsStDevARequest instance
     */
    public IWorkbookFunctionsStDevARequest buildRequest(final List<Option> requestOptions) {
