...
public class BaseWorkbookFunctionsImSinhRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsImSinhRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
     ...
     * @return The IWorkbookFunctionsImSinhRequest instance
     */
    public IWorkbookFunctionsImSinhRequest buildRequest(final List<Option> requestOptions) {
