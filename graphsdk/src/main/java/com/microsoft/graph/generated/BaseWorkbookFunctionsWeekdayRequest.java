...
public class BaseWorkbookFunctionsWeekdayRequest extends BaseRequest implements IBaseWorkbookFunctionsWeekdayRequest {
    protected final WorkbookFunctionsWeekdayBody mBody;
     ...
     */
    public BaseWorkbookFunctionsWeekdayRequest(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        mBody = new WorkbookFunctionsWeekdayBody();
    }
