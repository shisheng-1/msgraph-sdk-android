...
public class BaseConversationThreadRequestBuilder extends BaseRequestBuilder implements IBaseConversationThreadRequestBuilder {
     ...
     */
    public BaseConversationThreadRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IConversationThreadRequest buildRequest(final List<Option> requestOptions) {
