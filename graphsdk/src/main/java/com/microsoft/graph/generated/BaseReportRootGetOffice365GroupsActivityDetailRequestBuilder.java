...
public class BaseReportRootGetOffice365GroupsActivityDetailRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetOffice365GroupsActivityDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.microsoft.graph.model.DateOnly date) {
     ...
     * @param requestOptions The options for this request
     */
    public BaseReportRootGetOffice365GroupsActivityDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
        super(requestUrl, client, requestOptions);
     ...
     * @return The IReportRootGetOffice365GroupsActivityDetailRequest instance
     */
    public IReportRootGetOffice365GroupsActivityDetailRequest buildRequest(final java.util.List<Option> requestOptions) {
