...
public class BaseWorkbookFunctionsDstDevPRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsDstDevPRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement database, final com.google.gson.JsonElement field, final com.google.gson.JsonElement criteria) {
     ...
     * @return The IWorkbookFunctionsDstDevPRequest instance
     */
    public IWorkbookFunctionsDstDevPRequest buildRequest(final List<Option> requestOptions) {
