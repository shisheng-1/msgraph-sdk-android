...
public class BaseUserReferenceRequestBuilder extends BaseRequestBuilder implements IBaseUserReferenceRequestBuilder {
     ...
     */
    public BaseUserReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IUserReferenceRequest buildRequest(final List<Option> requestOptions) {
