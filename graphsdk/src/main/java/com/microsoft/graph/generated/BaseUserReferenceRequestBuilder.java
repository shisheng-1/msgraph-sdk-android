...
public class BaseUserReferenceRequestBuilder extends BaseRequestBuilder implements IBaseUserReferenceRequestBuilder {
     ...
     */
    public BaseUserReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options) {
     ...
     */
    public IUserReferenceRequest buildRequest(final List<Option> options) {
        return new UserReferenceRequest(getRequestUrl(), getClient(), options);
    }
}
