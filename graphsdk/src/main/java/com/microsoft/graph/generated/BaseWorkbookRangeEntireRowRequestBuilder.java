...
public class BaseWorkbookRangeEntireRowRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookRangeEntireRowRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookRangeEntireRowRequest instance
     */
    public IWorkbookRangeEntireRowRequest buildRequest(final List<Option> requestOptions) {
