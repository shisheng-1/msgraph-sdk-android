 ...
 */
public class BaseWorkbookRangeFormatAutofitColumnsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookRangeFormatAutofitColumnsRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookRangeFormatAutofitColumnsRequest instance
     */
    public IWorkbookRangeFormatAutofitColumnsRequest buildRequest(final List<Option> requestOptions) {
