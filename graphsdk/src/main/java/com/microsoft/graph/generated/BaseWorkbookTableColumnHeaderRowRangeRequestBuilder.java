...
public class BaseWorkbookTableColumnHeaderRowRangeRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookTableColumnHeaderRowRangeRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookTableColumnHeaderRowRangeRequest instance
     */
    public IWorkbookTableColumnHeaderRowRangeRequest buildRequest(final List<Option> requestOptions) {
