...
public class BaseGroupLifecyclePolicyAddGroupRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseGroupLifecyclePolicyAddGroupRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String groupId) {
     ...
     * @return The IGroupLifecyclePolicyAddGroupRequest instance
     */
    public IGroupLifecyclePolicyAddGroupRequest buildRequest(final java.util.List<Option> requestOptions) {
