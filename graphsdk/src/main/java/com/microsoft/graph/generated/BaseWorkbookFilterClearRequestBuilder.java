...
/**
 * The class for the Base Workbook Filter Clear Request Builder.
 */
public class BaseWorkbookFilterClearRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookFilterClearRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookFilterClearRequest instance
     */
    public IWorkbookFilterClearRequest buildRequest(final List<Option> requestOptions) {
