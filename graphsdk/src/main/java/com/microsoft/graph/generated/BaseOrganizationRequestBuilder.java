...
public class BaseOrganizationRequestBuilder extends BaseRequestBuilder implements IBaseOrganizationRequestBuilder {
     ...
     */
    public BaseOrganizationRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IOrganizationRequest buildRequest(final List<Option> requestOptions) {
