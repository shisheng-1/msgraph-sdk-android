...
/**
 * The class for the Base Workbook Range Offset Range Request.
 */
public class BaseWorkbookRangeOffsetRangeRequest extends BaseRequest implements IBaseWorkbookRangeOffsetRangeRequest {
     ...
     */
    public BaseWorkbookRangeOffsetRangeRequest(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
