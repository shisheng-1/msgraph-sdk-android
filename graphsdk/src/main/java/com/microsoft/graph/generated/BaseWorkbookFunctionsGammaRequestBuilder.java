...
public class BaseWorkbookFunctionsGammaRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsGammaRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement x) {
     ...
     * @return The IWorkbookFunctionsGammaRequest instance
     */
    public IWorkbookFunctionsGammaRequest buildRequest(final List<Option> requestOptions) {
