...
public class BaseWorkbookFunctionsNotRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsNotRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement logical) {
     ...
     * @return The IWorkbookFunctionsNotRequest instance
     */
    public IWorkbookFunctionsNotRequest buildRequest(final List<Option> requestOptions) {
