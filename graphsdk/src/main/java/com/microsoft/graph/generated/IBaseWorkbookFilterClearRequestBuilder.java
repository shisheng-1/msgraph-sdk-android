...
/**
 * The interface for the Base Workbook Filter Clear Request Builder.
 */
public interface IBaseWorkbookFilterClearRequestBuilder extends IRequestBuilder {
     ...
     * @return The IWorkbookFilterClearRequest instance
     */
    IWorkbookFilterClearRequest buildRequest(final List<Option> requestOptions);
}
