...
public class BaseReportRootGetOffice365GroupsActivityFileCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetOffice365GroupsActivityFileCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetOffice365GroupsActivityFileCountsRequest instance
     */
    public IReportRootGetOffice365GroupsActivityFileCountsRequest buildRequest(final java.util.List<Option> requestOptions) {
