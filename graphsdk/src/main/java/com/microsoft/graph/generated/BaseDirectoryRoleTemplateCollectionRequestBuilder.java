...
public class BaseDirectoryRoleTemplateCollectionRequestBuilder extends BaseRequestBuilder implements IBaseDirectoryRoleTemplateCollectionRequestBuilder {
     ...
     */
    public BaseDirectoryRoleTemplateCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
    ...
    public IDirectoryRoleTemplateCollectionRequest buildRequest(final List<Option> requestOptions) {
