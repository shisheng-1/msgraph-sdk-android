...
public class BaseWorkbookFunctionsImSechRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsImSechRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
     ...
     * @return The IWorkbookFunctionsImSechRequest instance
     */
    public IWorkbookFunctionsImSechRequest buildRequest(final List<Option> requestOptions) {
