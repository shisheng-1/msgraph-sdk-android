...
/**
 * The class for the Base Report Root Get Skype For Business Organizer Activity Counts Request Builder.
 */
public class BaseReportRootGetSkypeForBusinessOrganizerActivityCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetSkypeForBusinessOrganizerActivityCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetSkypeForBusinessOrganizerActivityCountsRequest instance
     */
    public IReportRootGetSkypeForBusinessOrganizerActivityCountsRequest buildRequest(final java.util.List<Option> requestOptions) {
