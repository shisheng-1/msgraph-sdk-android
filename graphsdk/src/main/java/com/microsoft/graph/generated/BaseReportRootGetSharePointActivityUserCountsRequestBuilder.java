...
public class BaseReportRootGetSharePointActivityUserCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetSharePointActivityUserCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetSharePointActivityUserCountsRequest instance
     */
    public IReportRootGetSharePointActivityUserCountsRequest buildRequest(final java.util.List<Option> requestOptions) {
