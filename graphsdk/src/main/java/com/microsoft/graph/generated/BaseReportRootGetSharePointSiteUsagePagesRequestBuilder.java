...
public class BaseReportRootGetSharePointSiteUsagePagesRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetSharePointSiteUsagePagesRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetSharePointSiteUsagePagesRequest instance
     */
    public IReportRootGetSharePointSiteUsagePagesRequest buildRequest(final java.util.List<Option> requestOptions) {
