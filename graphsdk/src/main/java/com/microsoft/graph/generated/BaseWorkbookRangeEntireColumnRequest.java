...
/**
 * The class for the Base Workbook Range Entire Column Request.
 */
public class BaseWorkbookRangeEntireColumnRequest extends BaseRequest implements IBaseWorkbookRangeEntireColumnRequest {
     ...
     */
    public BaseWorkbookRangeEntireColumnRequest(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
