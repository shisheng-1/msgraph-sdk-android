...
/**
 * The interface for the Base Workbook Functions Fact Double Request Builder.
 */
public interface IBaseWorkbookFunctionsFactDoubleRequestBuilder extends IRequestBuilder {
     ...
     * @return The IWorkbookFunctionsFactDoubleRequest instance
     */
    IWorkbookFunctionsFactDoubleRequest buildRequest(final List<Option> requestOptions);
}
