...
/**
 * The class for the Base Report Root Get Skype For Business Organizer Activity Minute Counts Request.
 */
public class BaseReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsRequest extends BaseRequest implements IBaseReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsRequest {
     ...
     */
    public BaseReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
