...
public class BaseWorkbookFunctionsErfCRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsErfCRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement x) {
     ...
     * @return The IWorkbookFunctionsErfCRequest instance
     */
    public IWorkbookFunctionsErfCRequest buildRequest(final List<Option> requestOptions) {
