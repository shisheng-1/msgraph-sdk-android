...
public class BaseWorkbookFunctionsQuotientRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsQuotientRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement numerator, final com.google.gson.JsonElement denominator) {
     ...
     * @return The IWorkbookFunctionsQuotientRequest instance
     */
    public IWorkbookFunctionsQuotientRequest buildRequest(final List<Option> requestOptions) {
