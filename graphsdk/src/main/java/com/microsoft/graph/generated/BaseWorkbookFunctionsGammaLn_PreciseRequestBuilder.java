...
public class BaseWorkbookFunctionsGammaLn_PreciseRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsGammaLn_PreciseRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement x) {
     ...
     * @return The IWorkbookFunctionsGammaLn_PreciseRequest instance
     */
    public IWorkbookFunctionsGammaLn_PreciseRequest buildRequest(final List<Option> requestOptions) {
