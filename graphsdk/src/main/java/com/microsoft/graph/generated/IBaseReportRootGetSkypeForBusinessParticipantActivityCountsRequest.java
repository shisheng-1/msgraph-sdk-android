...
/**
 * The interface for the Base Report Root Get Skype For Business Participant Activity Counts Request.
 */
public interface IBaseReportRootGetSkypeForBusinessParticipantActivityCountsRequest {
     ...
     */
    IReportRootGetSkypeForBusinessParticipantActivityCountsRequest select(final String value);
     ...
     * @return The updated request
     */
    IReportRootGetSkypeForBusinessParticipantActivityCountsRequest expand(final String value);
