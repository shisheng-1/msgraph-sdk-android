...
public class BaseReportRootGetTeamsDeviceUsageUserCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetTeamsDeviceUsageUserCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetTeamsDeviceUsageUserCountsRequest instance
     */
    public IReportRootGetTeamsDeviceUsageUserCountsRequest buildRequest(final java.util.List<Option> requestOptions) {
