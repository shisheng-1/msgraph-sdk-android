...
/**
 * The class for the Base Workbook Functions Xnpv Request Builder.
 */
public class BaseWorkbookFunctionsXnpvRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsXnpvRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement rate, final com.google.gson.JsonElement values, final com.google.gson.JsonElement dates) {
     ...
     * @return The IWorkbookFunctionsXnpvRequest instance
     */
    public IWorkbookFunctionsXnpvRequest buildRequest(final List<Option> requestOptions) {
