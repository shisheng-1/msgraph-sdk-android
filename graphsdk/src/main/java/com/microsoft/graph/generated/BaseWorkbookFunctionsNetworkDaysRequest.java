...
public class BaseWorkbookFunctionsNetworkDaysRequest extends BaseRequest implements IBaseWorkbookFunctionsNetworkDaysRequest {
    protected final WorkbookFunctionsNetworkDaysBody mBody;
     ...
     */
    public BaseWorkbookFunctionsNetworkDaysRequest(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        mBody = new WorkbookFunctionsNetworkDaysBody();
    }
