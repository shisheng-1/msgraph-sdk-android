 ...
 */
public class BaseMailFolderMoveRequestBuilder extends BaseRequestBuilder {
    ...
    public IMailFolderMoveRequest buildRequest(final List<Option> options) {
        return new MailFolderMoveRequest(getRequestUrl(), getClient(), options, mDestinationId);
    }
}
