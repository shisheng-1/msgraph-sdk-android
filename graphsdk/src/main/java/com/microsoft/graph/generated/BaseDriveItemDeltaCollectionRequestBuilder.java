 ...
 */
public class BaseDriveItemDeltaCollectionRequestBuilder extends BaseRequestBuilder implements IBaseDriveItemDeltaCollectionRequestBuilder {
    ...
    public IDriveItemDeltaCollectionRequest buildRequest(final List<Option> options) {
        return new DriveItemDeltaCollectionRequest(getRequestUrl(), getClient(), options);
    }
}
