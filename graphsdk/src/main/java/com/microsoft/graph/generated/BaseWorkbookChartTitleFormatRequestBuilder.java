...
public class BaseWorkbookChartTitleFormatRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartTitleFormatRequestBuilder {
     ...
     */
    public BaseWorkbookChartTitleFormatRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookChartTitleFormatRequest buildRequest(final List<Option> requestOptions) {
