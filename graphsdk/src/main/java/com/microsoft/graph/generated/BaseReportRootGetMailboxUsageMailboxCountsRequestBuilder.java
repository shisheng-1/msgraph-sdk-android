...
public class BaseReportRootGetMailboxUsageMailboxCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetMailboxUsageMailboxCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetMailboxUsageMailboxCountsRequest instance
     */
    public IReportRootGetMailboxUsageMailboxCountsRequest buildRequest(final java.util.List<Option> requestOptions) {
