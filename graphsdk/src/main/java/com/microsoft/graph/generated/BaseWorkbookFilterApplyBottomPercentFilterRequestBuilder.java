...
public class BaseWorkbookFilterApplyBottomPercentFilterRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFilterApplyBottomPercentFilterRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final Integer percent) {
     ...
     * @return The IWorkbookFilterApplyBottomPercentFilterRequest instance
     */
    public IWorkbookFilterApplyBottomPercentFilterRequest buildRequest(final List<Option> requestOptions) {
