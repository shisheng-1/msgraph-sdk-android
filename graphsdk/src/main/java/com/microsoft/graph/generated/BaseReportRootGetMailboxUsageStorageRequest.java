...
/**
 * The class for the Base Report Root Get Mailbox Usage Storage Request.
 */
public class BaseReportRootGetMailboxUsageStorageRequest extends BaseRequest implements IBaseReportRootGetMailboxUsageStorageRequest {
     ...
     */
    public BaseReportRootGetMailboxUsageStorageRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IReportRootGetMailboxUsageStorageRequest select(final String value) {
        getQueryOptions().add(new QueryOption("$select", value));
        return (ReportRootGetMailboxUsageStorageRequest)this;
    }
     ...
     * @return The updated request
     */
    public IReportRootGetMailboxUsageStorageRequest expand(final String value) {
