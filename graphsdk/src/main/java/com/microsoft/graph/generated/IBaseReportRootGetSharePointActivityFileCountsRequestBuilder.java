...
/**
 * The interface for the Base Report Root Get Share Point Activity File Counts Request Builder.
 */
public interface IBaseReportRootGetSharePointActivityFileCountsRequestBuilder extends IRequestBuilder {
     ...
     * @return The IReportRootGetSharePointActivityFileCountsRequest instance
     */
    IReportRootGetSharePointActivityFileCountsRequest buildRequest(final java.util.List<Option> requestOptions);
}
