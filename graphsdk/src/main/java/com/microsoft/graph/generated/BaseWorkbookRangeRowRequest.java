...
/**
 * The class for the Base Workbook Range Row Request.
 */
public class BaseWorkbookRangeRowRequest extends BaseRequest implements IBaseWorkbookRangeRowRequest {
     ...
     */
    public BaseWorkbookRangeRowRequest(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
