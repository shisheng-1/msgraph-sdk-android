...
public class BaseEducationSchoolWithReferenceRequestBuilder extends BaseRequestBuilder implements IBaseEducationSchoolWithReferenceRequestBuilder {
     ...
     */
    public BaseEducationSchoolWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IEducationSchoolWithReferenceRequest buildRequest(final java.util.List<Option> requestOptions) {
