...
public class BaseWorkbookFunctionsSumSqRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsSumSqRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsSumSqRequest instance
     */
    public IWorkbookFunctionsSumSqRequest buildRequest(final List<Option> requestOptions) {
