...
public class BaseWorkbookRangeLastColumnRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookRangeLastColumnRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookRangeLastColumnRequest instance
     */
    public IWorkbookRangeLastColumnRequest buildRequest(final List<Option> requestOptions) {
