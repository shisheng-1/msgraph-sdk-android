...
public class BaseUserActivityRecentCollectionRequestBuilder extends BaseFunctionRequestBuilder implements IBaseUserActivityRecentCollectionRequestBuilder {
     ...
     */
    public BaseUserActivityRecentCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
    ...
    public IUserActivityRecentCollectionRequest buildRequest(final java.util.List<Option> requestOptions) {
