...
public class BaseWorkbookFunctionsUpperRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsUpperRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement text) {
     ...
     * @return The IWorkbookFunctionsUpperRequest instance
     */
    public IWorkbookFunctionsUpperRequest buildRequest(final List<Option> requestOptions) {
