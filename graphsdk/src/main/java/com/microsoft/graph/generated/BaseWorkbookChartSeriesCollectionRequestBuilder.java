...
public class BaseWorkbookChartSeriesCollectionRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartSeriesCollectionRequestBuilder {
     ...
     */
    public BaseWorkbookChartSeriesCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
    ...
    public IWorkbookChartSeriesCollectionRequest buildRequest(final List<Option> requestOptions) {
