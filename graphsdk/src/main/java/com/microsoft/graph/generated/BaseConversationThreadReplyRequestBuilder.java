 ...
 */
public class BaseConversationThreadReplyRequestBuilder extends BaseRequestBuilder {
    ...
    public IConversationThreadReplyRequest buildRequest(final List<Option> options) {
        return new ConversationThreadReplyRequest(getRequestUrl(), getClient(), options, mPost);
    }
}
