...
public class BaseReportRootGetMailboxUsageStorageRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetMailboxUsageStorageRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetMailboxUsageStorageRequest instance
     */
    public IReportRootGetMailboxUsageStorageRequest buildRequest(final java.util.List<Option> requestOptions) {
