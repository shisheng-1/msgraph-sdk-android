...
public class BaseWorkbookFunctionsMonthRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsMonthRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement serialNumber) {
     ...
     * @return The IWorkbookFunctionsMonthRequest instance
     */
    public IWorkbookFunctionsMonthRequest buildRequest(final List<Option> requestOptions) {
