...
public class BaseSingleValueLegacyExtendedPropertyRequestBuilder extends BaseRequestBuilder implements IBaseSingleValueLegacyExtendedPropertyRequestBuilder {
     ...
     */
    public BaseSingleValueLegacyExtendedPropertyRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public ISingleValueLegacyExtendedPropertyRequest buildRequest(final List<Option> requestOptions) {
