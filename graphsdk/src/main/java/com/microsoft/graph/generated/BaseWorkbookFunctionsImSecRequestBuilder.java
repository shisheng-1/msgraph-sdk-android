...
public class BaseWorkbookFunctionsImSecRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsImSecRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
     ...
     * @return The IWorkbookFunctionsImSecRequest instance
     */
    public IWorkbookFunctionsImSecRequest buildRequest(final List<Option> requestOptions) {
