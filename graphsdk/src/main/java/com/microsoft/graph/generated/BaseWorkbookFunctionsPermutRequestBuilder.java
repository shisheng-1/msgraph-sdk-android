...
public class BaseWorkbookFunctionsPermutRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsPermutRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number, final com.google.gson.JsonElement numberChosen) {
     ...
     * @return The IWorkbookFunctionsPermutRequest instance
     */
    public IWorkbookFunctionsPermutRequest buildRequest(final List<Option> requestOptions) {
