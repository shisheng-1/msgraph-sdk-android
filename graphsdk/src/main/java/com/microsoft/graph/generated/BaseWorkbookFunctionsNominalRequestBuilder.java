...
public class BaseWorkbookFunctionsNominalRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsNominalRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement effectRate, final com.google.gson.JsonElement npery) {
     ...
     * @return The IWorkbookFunctionsNominalRequest instance
     */
    public IWorkbookFunctionsNominalRequest buildRequest(final List<Option> requestOptions) {
