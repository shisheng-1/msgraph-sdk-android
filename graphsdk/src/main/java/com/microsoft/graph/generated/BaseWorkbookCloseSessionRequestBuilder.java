...
public class BaseWorkbookCloseSessionRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookCloseSessionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookCloseSessionRequest instance
     */
    public IWorkbookCloseSessionRequest buildRequest(final List<Option> requestOptions) {
