...
public class BaseWorkbookRangeFillClearRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookRangeFillClearRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookRangeFillClearRequest instance
     */
    public IWorkbookRangeFillClearRequest buildRequest(final List<Option> requestOptions) {
