...
public class BaseReportRootGetTeamsDeviceUsageUserDetailRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetTeamsDeviceUsageUserDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.microsoft.graph.model.DateOnly date) {
     ...
     * @param requestOptions The options for this request
     */
    public BaseReportRootGetTeamsDeviceUsageUserDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
        super(requestUrl, client, requestOptions);
     ...
     * @return The IReportRootGetTeamsDeviceUsageUserDetailRequest instance
     */
    public IReportRootGetTeamsDeviceUsageUserDetailRequest buildRequest(final java.util.List<Option> requestOptions) {
