...
public class BaseWorkbookChartSeriesRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartSeriesRequestBuilder {
     ...
     */
    public BaseWorkbookChartSeriesRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookChartSeriesRequest buildRequest(final List<Option> requestOptions) {
    ...
    public IWorkbookChartPointRequestBuilder getPoints(final String id) {
