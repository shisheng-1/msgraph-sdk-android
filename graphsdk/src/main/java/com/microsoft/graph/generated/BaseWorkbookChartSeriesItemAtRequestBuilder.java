...
public class BaseWorkbookChartSeriesItemAtRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookChartSeriesItemAtRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final Integer index) {
     ...
     * @return The IWorkbookChartSeriesItemAtRequest instance
     */
    public IWorkbookChartSeriesItemAtRequest buildRequest(final List<Option> requestOptions) {
