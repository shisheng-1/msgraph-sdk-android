...
public class BaseWorkbookFunctionsAtanRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsAtanRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
     ...
     * @return The IWorkbookFunctionsAtanRequest instance
     */
    public IWorkbookFunctionsAtanRequest buildRequest(final List<Option> requestOptions) {
