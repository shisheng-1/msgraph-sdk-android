...
public class BaseReportRootGetYammerActivityCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetYammerActivityCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetYammerActivityCountsRequest instance
     */
    public IReportRootGetYammerActivityCountsRequest buildRequest(final java.util.List<Option> requestOptions) {
