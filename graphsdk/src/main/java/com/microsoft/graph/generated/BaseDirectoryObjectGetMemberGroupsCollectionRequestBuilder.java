 ...
 */
public class BaseDirectoryObjectGetMemberGroupsCollectionRequestBuilder extends BaseRequestBuilder implements IBaseDirectoryObjectGetMemberGroupsCollectionRequestBuilder {
    ...
    public IDirectoryObjectGetMemberGroupsCollectionRequest buildRequest(final List<Option> options) {
        return new DirectoryObjectGetMemberGroupsCollectionRequest(getRequestUrl(), getClient(), options, mSecurityEnabledOnly);
    }
}
