 ...
 */
public class BaseUserChangePasswordRequestBuilder extends BaseRequestBuilder {
    ...
    public IUserChangePasswordRequest buildRequest(final List<Option> options) {
        return new UserChangePasswordRequest(getRequestUrl(), getClient(), options, mCurrentPassword, mNewPassword);
    }
}
