...
/**
 * The interface for the Base Report Root Get Skype For Business Organizer Activity User Counts Request Builder.
 */
public interface IBaseReportRootGetSkypeForBusinessOrganizerActivityUserCountsRequestBuilder extends IRequestBuilder {
     ...
     * @return The IReportRootGetSkypeForBusinessOrganizerActivityUserCountsRequest instance
     */
    IReportRootGetSkypeForBusinessOrganizerActivityUserCountsRequest buildRequest(final java.util.List<Option> requestOptions);
}
