...
public class BaseWorkbookChartPointRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartPointRequestBuilder {
     ...
     */
    public BaseWorkbookChartPointRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookChartPointRequest buildRequest(final List<Option> requestOptions) {
