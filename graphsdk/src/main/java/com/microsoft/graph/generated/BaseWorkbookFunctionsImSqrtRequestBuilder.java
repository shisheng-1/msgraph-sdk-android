...
/**
 * The class for the Base Workbook Functions Im Sqrt Request Builder.
 */
public class BaseWorkbookFunctionsImSqrtRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsImSqrtRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
     ...
     * @return The IWorkbookFunctionsImSqrtRequest instance
     */
    public IWorkbookFunctionsImSqrtRequest buildRequest(final List<Option> requestOptions) {
