...
public class BaseWorkbookChartPointCountRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookChartPointCountRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookChartPointCountRequest instance
     */
    public IWorkbookChartPointCountRequest buildRequest(final List<Option> requestOptions) {
