...
/**
 * The class for the Base Report Root Get Teams User Activity User Detail Request.
 */
public class BaseReportRootGetTeamsUserActivityUserDetailRequest extends BaseRequest implements IBaseReportRootGetTeamsUserActivityUserDetailRequest {
     ...
     */
    public BaseReportRootGetTeamsUserActivityUserDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
