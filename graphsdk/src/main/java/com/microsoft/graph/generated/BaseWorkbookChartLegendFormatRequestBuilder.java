...
public class BaseWorkbookChartLegendFormatRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartLegendFormatRequestBuilder {
     ...
     */
    public BaseWorkbookChartLegendFormatRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookChartLegendFormatRequest buildRequest(final List<Option> requestOptions) {
