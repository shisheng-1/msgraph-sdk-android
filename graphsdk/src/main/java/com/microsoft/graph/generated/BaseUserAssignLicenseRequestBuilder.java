 ...
 */
public class BaseUserAssignLicenseRequestBuilder extends BaseRequestBuilder {

    public final List<AssignedLicense> mAddLicenses;
    public final List<java.util.UUID> mRemoveLicenses;
    ...
    public BaseUserAssignLicenseRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options, final List<AssignedLicense> addLicenses, final List<java.util.UUID> removeLicenses) {
        ...
        mAddLicenses = addLicenses;
        mRemoveLicenses = removeLicenses;
    }
    ...
    public IUserAssignLicenseRequest buildRequest(final List<Option> options) {
        return new UserAssignLicenseRequest(getRequestUrl(), getClient(), options, mAddLicenses, mRemoveLicenses);
    }
}
