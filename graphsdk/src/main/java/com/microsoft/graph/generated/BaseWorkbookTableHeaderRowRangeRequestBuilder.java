...
public class BaseWorkbookTableHeaderRowRangeRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookTableHeaderRowRangeRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookTableHeaderRowRangeRequest instance
     */
    public IWorkbookTableHeaderRowRangeRequest buildRequest(final List<Option> requestOptions) {
