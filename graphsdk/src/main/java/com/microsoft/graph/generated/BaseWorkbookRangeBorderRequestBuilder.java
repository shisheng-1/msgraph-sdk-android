...
public class BaseWorkbookRangeBorderRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookRangeBorderRequestBuilder {
     ...
     */
    public BaseWorkbookRangeBorderRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookRangeBorderRequest buildRequest(final List<Option> requestOptions) {
