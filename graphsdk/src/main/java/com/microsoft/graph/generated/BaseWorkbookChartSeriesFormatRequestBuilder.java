...
public class BaseWorkbookChartSeriesFormatRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartSeriesFormatRequestBuilder {
     ...
     */
    public BaseWorkbookChartSeriesFormatRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookChartSeriesFormatRequest buildRequest(final List<Option> requestOptions) {
