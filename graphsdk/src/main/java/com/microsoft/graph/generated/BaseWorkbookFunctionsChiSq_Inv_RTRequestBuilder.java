...
public class BaseWorkbookFunctionsChiSq_Inv_RTRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsChiSq_Inv_RTRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement probability, final com.google.gson.JsonElement degFreedom) {
     ...
     * @return The IWorkbookFunctionsChiSq_Inv_RTRequest instance
     */
    public IWorkbookFunctionsChiSq_Inv_RTRequest buildRequest(final List<Option> requestOptions) {
