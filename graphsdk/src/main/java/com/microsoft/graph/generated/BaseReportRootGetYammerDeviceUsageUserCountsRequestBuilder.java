...
public class BaseReportRootGetYammerDeviceUsageUserCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetYammerDeviceUsageUserCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetYammerDeviceUsageUserCountsRequest instance
     */
    public IReportRootGetYammerDeviceUsageUserCountsRequest buildRequest(final java.util.List<Option> requestOptions) {
