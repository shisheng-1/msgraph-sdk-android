...
public class BaseWorkbookFunctionsDsumRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsDsumRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement database, final com.google.gson.JsonElement field, final com.google.gson.JsonElement criteria) {
     ...
     * @return The IWorkbookFunctionsDsumRequest instance
     */
    public IWorkbookFunctionsDsumRequest buildRequest(final List<Option> requestOptions) {
