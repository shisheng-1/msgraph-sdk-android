...
/**
 * The class for the Base Report Root Get Share Point Activity Pages Request Builder.
 */
public class BaseReportRootGetSharePointActivityPagesRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetSharePointActivityPagesRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetSharePointActivityPagesRequest instance
     */
    public IReportRootGetSharePointActivityPagesRequest buildRequest(final java.util.List<Option> requestOptions) {
