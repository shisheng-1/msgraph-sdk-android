...
public class BaseWorkbookFunctionsBin2DecRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsBin2DecRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
     ...
     * @return The IWorkbookFunctionsBin2DecRequest instance
     */
    public IWorkbookFunctionsBin2DecRequest buildRequest(final List<Option> requestOptions) {
