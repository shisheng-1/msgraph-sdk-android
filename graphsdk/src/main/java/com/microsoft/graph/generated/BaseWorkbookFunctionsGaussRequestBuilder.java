...
public class BaseWorkbookFunctionsGaussRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsGaussRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement x) {
     ...
     * @return The IWorkbookFunctionsGaussRequest instance
     */
    public IWorkbookFunctionsGaussRequest buildRequest(final List<Option> requestOptions) {
