...
public class BaseDirectoryRoleTemplateRequestBuilder extends BaseRequestBuilder implements IBaseDirectoryRoleTemplateRequestBuilder {
     ...
     */
    public BaseDirectoryRoleTemplateRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options) {
     ...
     */
    public IDirectoryRoleTemplateRequest buildRequest(final List<Option> options) {
        return new DirectoryRoleTemplateRequest(getRequestUrl(), getClient(), options);
    }
