...
public class BaseDirectoryRoleTemplateRequestBuilder extends BaseRequestBuilder implements IBaseDirectoryRoleTemplateRequestBuilder {
     ...
     */
    public BaseDirectoryRoleTemplateRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IDirectoryRoleTemplateRequest buildRequest(final List<Option> requestOptions) {
