...
public class BaseWorkbookFunctionsValueRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsValueRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement text) {
     ...
     * @return The IWorkbookFunctionsValueRequest instance
     */
    public IWorkbookFunctionsValueRequest buildRequest(final List<Option> requestOptions) {
