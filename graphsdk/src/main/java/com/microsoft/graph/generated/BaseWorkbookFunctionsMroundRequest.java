...
public class BaseWorkbookFunctionsMroundRequest extends BaseRequest implements IBaseWorkbookFunctionsMroundRequest {
    protected final WorkbookFunctionsMroundBody mBody;
     ...
     */
    public BaseWorkbookFunctionsMroundRequest(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        mBody = new WorkbookFunctionsMroundBody();
    }
