...
public class BaseReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsRequest instance
     */
    public IReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsRequest buildRequest(final java.util.List<Option> requestOptions) {
