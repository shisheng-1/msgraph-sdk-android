...
public class BaseWorkbookFunctionsOrRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsOrRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsOrRequest instance
     */
    public IWorkbookFunctionsOrRequest buildRequest(final List<Option> requestOptions) {
