 ...
 */
public class BaseWorkbookFunctionsTodayRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsTodayRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookFunctionsTodayRequest instance
     */
    public IWorkbookFunctionsTodayRequest buildRequest(final List<Option> requestOptions) {
