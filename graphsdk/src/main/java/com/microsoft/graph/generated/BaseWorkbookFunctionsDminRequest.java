...
public class BaseWorkbookFunctionsDminRequest extends BaseRequest implements IBaseWorkbookFunctionsDminRequest {
    protected final WorkbookFunctionsDminBody mBody;
     ...
     */
    public BaseWorkbookFunctionsDminRequest(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        mBody = new WorkbookFunctionsDminBody();
    }
