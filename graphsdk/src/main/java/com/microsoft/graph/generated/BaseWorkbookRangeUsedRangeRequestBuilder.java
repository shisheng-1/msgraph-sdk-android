...
public class BaseWorkbookRangeUsedRangeRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookRangeUsedRangeRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @param requestOptions The options for this request
     */
    public BaseWorkbookRangeUsedRangeRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final Boolean valuesOnly) {
        super(requestUrl, client, requestOptions);
     ...
     * @return The IWorkbookRangeUsedRangeRequest instance
     */
    public IWorkbookRangeUsedRangeRequest buildRequest(final List<Option> requestOptions) {
