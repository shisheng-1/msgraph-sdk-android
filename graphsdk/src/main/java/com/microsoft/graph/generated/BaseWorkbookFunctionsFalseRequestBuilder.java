 ...
 */
public class BaseWorkbookFunctionsFalseRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsFalseRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookFunctionsFalseRequest instance
     */
    public IWorkbookFunctionsFalseRequest buildRequest(final List<Option> requestOptions) {
