...
public class BaseReportRootGetSharePointSiteUsageStorageRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetSharePointSiteUsageStorageRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetSharePointSiteUsageStorageRequest instance
     */
    public IReportRootGetSharePointSiteUsageStorageRequest buildRequest(final java.util.List<Option> requestOptions) {
