 ...
 */
public class BasePostForwardRequestBuilder extends BaseRequestBuilder {

    public final String mComment;
    public final List<Recipient> mToRecipients;
    ...
    public IPostForwardRequest buildRequest(final List<Option> options) {
        return new PostForwardRequest(getRequestUrl(), getClient(), options, mComment, mToRecipients);
    }
}
