...
public class BaseWorkbookTableRowCountRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookTableRowCountRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookTableRowCountRequest instance
     */
    public IWorkbookTableRowCountRequest buildRequest(final List<Option> requestOptions) {
