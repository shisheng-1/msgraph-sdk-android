...
public class BaseWorkbookTableReapplyFiltersRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookTableReapplyFiltersRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookTableReapplyFiltersRequest instance
     */
    public IWorkbookTableReapplyFiltersRequest buildRequest(final List<Option> requestOptions) {
