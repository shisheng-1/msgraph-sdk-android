 ...
 */
public class BaseEventDeclineRequestBuilder extends BaseRequestBuilder {
    ...
    public IEventDeclineRequest buildRequest(final List<Option> options) {
        return new EventDeclineRequest(getRequestUrl(), getClient(), options, mComment, mSendResponse);
    }
}
