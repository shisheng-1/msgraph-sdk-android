...
/**
 * The class for the Base Report Root Get Office365Services User Counts Request.
 */
public class BaseReportRootGetOffice365ServicesUserCountsRequest extends BaseRequest implements IBaseReportRootGetOffice365ServicesUserCountsRequest {
     ...
     */
    public BaseReportRootGetOffice365ServicesUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
