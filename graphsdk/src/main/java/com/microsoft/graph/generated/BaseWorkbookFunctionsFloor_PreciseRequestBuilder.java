...
public class BaseWorkbookFunctionsFloor_PreciseRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsFloor_PreciseRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number, final com.google.gson.JsonElement significance) {
     ...
     * @return The IWorkbookFunctionsFloor_PreciseRequest instance
     */
    public IWorkbookFunctionsFloor_PreciseRequest buildRequest(final List<Option> requestOptions) {
