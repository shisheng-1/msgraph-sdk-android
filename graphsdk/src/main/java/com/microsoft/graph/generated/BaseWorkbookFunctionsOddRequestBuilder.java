...
public class BaseWorkbookFunctionsOddRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsOddRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
     ...
     * @return The IWorkbookFunctionsOddRequest instance
     */
    public IWorkbookFunctionsOddRequest buildRequest(final List<Option> requestOptions) {
