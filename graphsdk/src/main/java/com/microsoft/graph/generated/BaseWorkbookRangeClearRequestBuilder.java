...
public class BaseWorkbookRangeClearRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookRangeClearRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final String applyTo) {
     ...
     * @return The IWorkbookRangeClearRequest instance
     */
    public IWorkbookRangeClearRequest buildRequest(final List<Option> requestOptions) {
