...
/**
 * The interface for the Base Report Root Get Email Activity Counts Request Builder.
 */
public interface IBaseReportRootGetEmailActivityCountsRequestBuilder extends IRequestBuilder {
     ...
     * @return The IReportRootGetEmailActivityCountsRequest instance
     */
    IReportRootGetEmailActivityCountsRequest buildRequest(final java.util.List<Option> requestOptions);
}
