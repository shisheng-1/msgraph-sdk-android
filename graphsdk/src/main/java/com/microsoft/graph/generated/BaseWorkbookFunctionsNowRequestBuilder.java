...
public class BaseWorkbookFunctionsNowRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsNowRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookFunctionsNowRequest instance
     */
    public IWorkbookFunctionsNowRequest buildRequest(final List<Option> requestOptions) {
