...
public class BaseWorkbookFunctionsSecRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsSecRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
     ...
     * @return The IWorkbookFunctionsSecRequest instance
     */
    public IWorkbookFunctionsSecRequest buildRequest(final List<Option> requestOptions) {
