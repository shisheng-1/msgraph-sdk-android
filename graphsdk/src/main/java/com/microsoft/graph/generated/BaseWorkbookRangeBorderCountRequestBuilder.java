...
public class BaseWorkbookRangeBorderCountRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookRangeBorderCountRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookRangeBorderCountRequest instance
     */
    public IWorkbookRangeBorderCountRequest buildRequest(final List<Option> requestOptions) {
