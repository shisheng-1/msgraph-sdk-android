...
public class BaseWorkbookFunctionsQuartile_IncRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsQuartile_IncRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement array, final com.google.gson.JsonElement quart) {
     ...
     * @return The IWorkbookFunctionsQuartile_IncRequest instance
     */
    public IWorkbookFunctionsQuartile_IncRequest buildRequest(final List<Option> requestOptions) {
