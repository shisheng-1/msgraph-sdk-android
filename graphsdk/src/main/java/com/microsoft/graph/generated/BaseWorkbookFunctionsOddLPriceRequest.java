...
public class BaseWorkbookFunctionsOddLPriceRequest extends BaseRequest implements IBaseWorkbookFunctionsOddLPriceRequest {
    protected final WorkbookFunctionsOddLPriceBody mBody;
     ...
     */
    public BaseWorkbookFunctionsOddLPriceRequest(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        mBody = new WorkbookFunctionsOddLPriceBody();
    }
