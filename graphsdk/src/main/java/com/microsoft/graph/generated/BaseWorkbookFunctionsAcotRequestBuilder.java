...
public class BaseWorkbookFunctionsAcotRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsAcotRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
     ...
     * @return The IWorkbookFunctionsAcotRequest instance
     */
    public IWorkbookFunctionsAcotRequest buildRequest(final List<Option> requestOptions) {
