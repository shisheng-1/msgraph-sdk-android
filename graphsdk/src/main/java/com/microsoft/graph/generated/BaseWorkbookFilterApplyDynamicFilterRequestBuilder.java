...
public class BaseWorkbookFilterApplyDynamicFilterRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFilterApplyDynamicFilterRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final String criteria) {
     ...
     * @return The IWorkbookFilterApplyDynamicFilterRequest instance
     */
    public IWorkbookFilterApplyDynamicFilterRequest buildRequest(final List<Option> requestOptions) {
