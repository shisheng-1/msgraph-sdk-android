...
public class BaseWorkbookFunctionsImSinRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsImSinRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement inumber) {
     ...
     * @return The IWorkbookFunctionsImSinRequest instance
     */
    public IWorkbookFunctionsImSinRequest buildRequest(final List<Option> requestOptions) {
