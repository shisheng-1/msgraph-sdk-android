...
public class BaseReportRootGetSharePointSiteUsageDetailRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetSharePointSiteUsageDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.microsoft.graph.model.DateOnly date) {
     ...
     * @param requestOptions The options for this request
     */
    public BaseReportRootGetSharePointSiteUsageDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
        super(requestUrl, client, requestOptions);
     ...
     * @return The IReportRootGetSharePointSiteUsageDetailRequest instance
     */
    public IReportRootGetSharePointSiteUsageDetailRequest buildRequest(final java.util.List<Option> requestOptions) {
