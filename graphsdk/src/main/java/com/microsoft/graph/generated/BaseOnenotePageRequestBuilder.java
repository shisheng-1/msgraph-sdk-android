...
public class BaseOnenotePageRequestBuilder extends BaseRequestBuilder implements IBaseOnenotePageRequestBuilder {
    ...
    public IOnenotePageCopyToSectionRequestBuilder getCopyToSection(final String id, final String groupId, final String siteCollectionId, final String siteId) {
