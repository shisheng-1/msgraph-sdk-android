...
public class BaseProfilePhotoStreamRequestBuilder extends BaseRequestBuilder implements IBaseProfilePhotoStreamRequestBuilder {
     ...
     */
    public BaseProfilePhotoStreamRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IProfilePhotoStreamRequest buildRequest(final List<Option> requestOptions) {
