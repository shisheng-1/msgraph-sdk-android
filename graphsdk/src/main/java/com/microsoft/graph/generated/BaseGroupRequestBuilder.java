...
public class BaseGroupRequestBuilder extends BaseRequestBuilder implements IBaseGroupRequestBuilder {
     ...
     */
    public BaseGroupRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options) {
     ...
     */
    public IGroupRequest buildRequest(final List<Option> options) {
        return new GroupRequest(getRequestUrl(), getClient(), options);
    }
