...
public class BaseWorkbookRangeDeleteRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookRangeDeleteRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final String shift) {
     ...
     * @return The IWorkbookRangeDeleteRequest instance
     */
    public IWorkbookRangeDeleteRequest buildRequest(final List<Option> requestOptions) {
