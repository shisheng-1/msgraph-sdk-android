...
public class BaseWorkbookFunctionsTrimMeanRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsTrimMeanRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement array, final com.google.gson.JsonElement percent) {
     ...
     * @return The IWorkbookFunctionsTrimMeanRequest instance
     */
    public IWorkbookFunctionsTrimMeanRequest buildRequest(final List<Option> requestOptions) {
