...
public class BaseWorkbookFunctionsPercentile_IncRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsPercentile_IncRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement array, final com.google.gson.JsonElement k) {
     ...
     * @return The IWorkbookFunctionsPercentile_IncRequest instance
     */
    public IWorkbookFunctionsPercentile_IncRequest buildRequest(final List<Option> requestOptions) {
