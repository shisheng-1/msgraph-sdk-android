...
public class BaseMessageCreateForwardRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseMessageCreateForwardRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IMessageCreateForwardRequest instance
     */
    public IMessageCreateForwardRequest buildRequest(final List<Option> requestOptions) {
