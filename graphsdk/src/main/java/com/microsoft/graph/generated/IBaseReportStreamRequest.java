...
/**
 * The interface for the Base Report Stream Request.
 */
public interface IBaseReportStreamRequest extends IHttpStreamRequest {
     ...
     * @param callback The callback to be called after success or failure.
     */
    void put(final byte[] fileContents, final ICallback<Report> callback);
     ...
     * @throws ClientException An exception occurs if there was an error while the request was sent.
     */
    Report put(final byte[] fileContents) throws ClientException;
}
