 ...
 */
public class BaseWorkbookFunctionsPiRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsPiRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookFunctionsPiRequest instance
     */
    public IWorkbookFunctionsPiRequest buildRequest(final List<Option> requestOptions) {
