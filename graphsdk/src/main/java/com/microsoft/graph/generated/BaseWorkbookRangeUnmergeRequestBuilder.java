...
public class BaseWorkbookRangeUnmergeRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookRangeUnmergeRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookRangeUnmergeRequest instance
     */
    public IWorkbookRangeUnmergeRequest buildRequest(final List<Option> requestOptions) {
