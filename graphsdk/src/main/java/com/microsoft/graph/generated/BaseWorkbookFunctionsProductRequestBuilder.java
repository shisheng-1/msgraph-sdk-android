...
public class BaseWorkbookFunctionsProductRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsProductRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsProductRequest instance
     */
    public IWorkbookFunctionsProductRequest buildRequest(final List<Option> requestOptions) {
