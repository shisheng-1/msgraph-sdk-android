...
public class BaseWorkbookTableConvertToRangeRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookTableConvertToRangeRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookTableConvertToRangeRequest instance
     */
    public IWorkbookTableConvertToRangeRequest buildRequest(final List<Option> requestOptions) {
