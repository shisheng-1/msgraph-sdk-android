...
public class BaseReportRootGetYammerActivityUserDetailRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetYammerActivityUserDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.microsoft.graph.model.DateOnly date) {
     ...
     * @param requestOptions The options for this request
     */
    public BaseReportRootGetYammerActivityUserDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
        super(requestUrl, client, requestOptions);
     ...
     * @return The IReportRootGetYammerActivityUserDetailRequest instance
     */
    public IReportRootGetYammerActivityUserDetailRequest buildRequest(final java.util.List<Option> requestOptions) {
