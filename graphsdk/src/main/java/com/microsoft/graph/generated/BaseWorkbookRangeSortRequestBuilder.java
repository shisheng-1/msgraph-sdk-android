...
public class BaseWorkbookRangeSortRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookRangeSortRequestBuilder {
     ...
     */
    public BaseWorkbookRangeSortRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookRangeSortRequest buildRequest(final List<Option> requestOptions) {
        return new WorkbookRangeSortRequest(getRequestUrl(), getClient(), requestOptions);
    }


    public IWorkbookRangeSortApplyRequestBuilder getApply(final List<WorkbookSortField> fields, final Boolean matchCase, final Boolean hasHeaders, final String orientation, final String method) {
