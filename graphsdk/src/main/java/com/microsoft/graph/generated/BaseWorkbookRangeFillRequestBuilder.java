...
public class BaseWorkbookRangeFillRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookRangeFillRequestBuilder {
     ...
     */
    public BaseWorkbookRangeFillRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookRangeFillRequest buildRequest(final List<Option> requestOptions) {
