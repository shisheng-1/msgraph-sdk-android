...
public class BaseWorkbookChartFillClearRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookChartFillClearRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookChartFillClearRequest instance
     */
    public IWorkbookChartFillClearRequest buildRequest(final List<Option> requestOptions) {
