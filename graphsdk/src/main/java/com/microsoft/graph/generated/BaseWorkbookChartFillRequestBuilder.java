...
public class BaseWorkbookChartFillRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartFillRequestBuilder {
     ...
     */
    public BaseWorkbookChartFillRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookChartFillRequest buildRequest(final List<Option> requestOptions) {
