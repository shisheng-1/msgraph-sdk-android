...
/**
 * The class for the Base Workbook Worksheet Cell Request.
 */
public class BaseWorkbookWorksheetCellRequest extends BaseRequest implements IBaseWorkbookWorksheetCellRequest {
     ...
     */
    public BaseWorkbookWorksheetCellRequest(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
