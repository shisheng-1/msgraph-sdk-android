...
public class BaseReportRootGetEmailAppUsageUserCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetEmailAppUsageUserCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetEmailAppUsageUserCountsRequest instance
     */
    public IReportRootGetEmailAppUsageUserCountsRequest buildRequest(final java.util.List<Option> requestOptions) {
