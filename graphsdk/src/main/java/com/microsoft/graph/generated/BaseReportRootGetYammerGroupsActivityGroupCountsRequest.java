...
/**
 * The class for the Base Report Root Get Yammer Groups Activity Group Counts Request.
 */
public class BaseReportRootGetYammerGroupsActivityGroupCountsRequest extends BaseRequest implements IBaseReportRootGetYammerGroupsActivityGroupCountsRequest {
     ...
     */
    public BaseReportRootGetYammerGroupsActivityGroupCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, Report.class);
    }

    /**
     * Patches the ReportRootGetYammerGroupsActivityGroupCounts
    ...
    /**
     * Puts the ReportRootGetYammerGroupsActivityGroupCounts
     *
