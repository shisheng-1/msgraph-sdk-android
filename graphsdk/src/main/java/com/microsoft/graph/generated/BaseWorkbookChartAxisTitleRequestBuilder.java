...
public class BaseWorkbookChartAxisTitleRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartAxisTitleRequestBuilder {
     ...
     */
    public BaseWorkbookChartAxisTitleRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookChartAxisTitleRequest buildRequest(final List<Option> requestOptions) {
