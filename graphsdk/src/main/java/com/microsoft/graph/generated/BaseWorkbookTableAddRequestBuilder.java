...
public class BaseWorkbookTableAddRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookTableAddRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final String address, final Boolean hasHeaders) {
     ...
     * @return The IWorkbookTableAddRequest instance
     */
    public IWorkbookTableAddRequest buildRequest(final List<Option> requestOptions) {
