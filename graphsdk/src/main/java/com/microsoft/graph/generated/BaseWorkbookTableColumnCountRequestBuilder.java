...
public class BaseWorkbookTableColumnCountRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookTableColumnCountRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookTableColumnCountRequest instance
     */
    public IWorkbookTableColumnCountRequest buildRequest(final List<Option> requestOptions) {
