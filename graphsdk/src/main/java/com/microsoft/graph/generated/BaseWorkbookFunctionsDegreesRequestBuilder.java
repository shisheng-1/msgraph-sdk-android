...
public class BaseWorkbookFunctionsDegreesRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsDegreesRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement angle) {
     ...
     * @return The IWorkbookFunctionsDegreesRequest instance
     */
    public IWorkbookFunctionsDegreesRequest buildRequest(final List<Option> requestOptions) {
