...
/**
 * The interface for the Base Report Root Get Share Point Activity Pages Request Builder.
 */
public interface IBaseReportRootGetSharePointActivityPagesRequestBuilder extends IRequestBuilder {
     ...
     * @return The IReportRootGetSharePointActivityPagesRequest instance
     */
    IReportRootGetSharePointActivityPagesRequest buildRequest(final java.util.List<Option> requestOptions);
}
