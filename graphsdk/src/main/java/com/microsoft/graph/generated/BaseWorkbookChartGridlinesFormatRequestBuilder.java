...
public class BaseWorkbookChartGridlinesFormatRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartGridlinesFormatRequestBuilder {
     ...
     */
    public BaseWorkbookChartGridlinesFormatRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookChartGridlinesFormatRequest buildRequest(final List<Option> requestOptions) {
