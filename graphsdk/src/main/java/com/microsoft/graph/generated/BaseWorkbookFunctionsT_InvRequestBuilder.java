...
public class BaseWorkbookFunctionsT_InvRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsT_InvRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement probability, final com.google.gson.JsonElement degFreedom) {
     ...
     * @return The IWorkbookFunctionsT_InvRequest instance
     */
    public IWorkbookFunctionsT_InvRequest buildRequest(final List<Option> requestOptions) {
