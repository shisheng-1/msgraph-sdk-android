...
public class BaseWorkbookRangeColumnRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookRangeColumnRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final Integer column) {
     ...
     * @return The IWorkbookRangeColumnRequest instance
     */
    public IWorkbookRangeColumnRequest buildRequest(final List<Option> requestOptions) {
