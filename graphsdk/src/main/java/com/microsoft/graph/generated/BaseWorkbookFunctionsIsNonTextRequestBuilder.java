...
public class BaseWorkbookFunctionsIsNonTextRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsIsNonTextRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement value) {
     ...
     * @return The IWorkbookFunctionsIsNonTextRequest instance
     */
    public IWorkbookFunctionsIsNonTextRequest buildRequest(final List<Option> requestOptions) {
