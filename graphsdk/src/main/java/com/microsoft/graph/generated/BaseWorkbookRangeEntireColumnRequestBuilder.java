...
public class BaseWorkbookRangeEntireColumnRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookRangeEntireColumnRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookRangeEntireColumnRequest instance
     */
    public IWorkbookRangeEntireColumnRequest buildRequest(final List<Option> requestOptions) {
