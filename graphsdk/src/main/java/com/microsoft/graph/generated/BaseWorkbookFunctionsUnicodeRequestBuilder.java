...
public class BaseWorkbookFunctionsUnicodeRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsUnicodeRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement text) {
     ...
     * @return The IWorkbookFunctionsUnicodeRequest instance
     */
    public IWorkbookFunctionsUnicodeRequest buildRequest(final List<Option> requestOptions) {
