...
public class BaseDirectoryRequestBuilder extends BaseRequestBuilder implements IBaseDirectoryRequestBuilder {
     ...
     */
    public BaseDirectoryRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IDirectoryRequest buildRequest(final java.util.List<Option> requestOptions) {
    ...
    public IDirectoryObjectRequestBuilder getDeletedItems(final String id) {
