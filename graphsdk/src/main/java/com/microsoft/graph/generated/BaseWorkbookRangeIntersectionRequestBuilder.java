...
public class BaseWorkbookRangeIntersectionRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookRangeIntersectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final String anotherRange) {
     ...
     * @return The IWorkbookRangeIntersectionRequest instance
     */
    public IWorkbookRangeIntersectionRequest buildRequest(final List<Option> requestOptions) {
