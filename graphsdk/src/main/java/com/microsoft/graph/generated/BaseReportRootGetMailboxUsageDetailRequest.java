...
/**
 * The class for the Base Report Root Get Mailbox Usage Detail Request.
 */
public class BaseReportRootGetMailboxUsageDetailRequest extends BaseRequest implements IBaseReportRootGetMailboxUsageDetailRequest {
     ...
     */
    public BaseReportRootGetMailboxUsageDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
