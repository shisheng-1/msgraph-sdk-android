...
public class BaseWorkbookFunctionsIsOddRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsIsOddRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
     ...
     * @return The IWorkbookFunctionsIsOddRequest instance
     */
    public IWorkbookFunctionsIsOddRequest buildRequest(final List<Option> requestOptions) {
