...
public class BaseWorkbookChartFontRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookChartFontRequestBuilder {
     ...
     */
    public BaseWorkbookChartFontRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookChartFontRequest buildRequest(final List<Option> requestOptions) {
