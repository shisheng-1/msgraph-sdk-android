...
public class BaseWorkbookFunctionsCoshRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsCoshRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
     ...
     * @return The IWorkbookFunctionsCoshRequest instance
     */
    public IWorkbookFunctionsCoshRequest buildRequest(final List<Option> requestOptions) {
