...
public class BaseWorkbookTableRowCollectionRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookTableRowCollectionRequestBuilder {
     ...
     */
    public BaseWorkbookTableRowCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
    ...
    public IWorkbookTableRowCollectionRequest buildRequest(final List<Option> requestOptions) {
