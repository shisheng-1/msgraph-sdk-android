...
public class BaseWorkbookFunctionsVarARequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsVarARequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsVarARequest instance
     */
    public IWorkbookFunctionsVarARequest buildRequest(final List<Option> requestOptions) {
