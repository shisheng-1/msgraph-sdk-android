...
public class BaseWorkbookFunctionsIsoWeekNumRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsIsoWeekNumRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement date) {
     ...
     * @return The IWorkbookFunctionsIsoWeekNumRequest instance
     */
    public IWorkbookFunctionsIsoWeekNumRequest buildRequest(final List<Option> requestOptions) {
