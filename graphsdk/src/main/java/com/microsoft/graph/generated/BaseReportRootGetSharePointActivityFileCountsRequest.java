...
public class BaseReportRootGetSharePointActivityFileCountsRequest extends BaseRequest implements IBaseReportRootGetSharePointActivityFileCountsRequest {
     ...
     */
    public BaseReportRootGetSharePointActivityFileCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
