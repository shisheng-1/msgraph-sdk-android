...
public class BaseWorkbookFunctionsCountIfRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsCountIfRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement range, final com.google.gson.JsonElement criteria) {
     ...
     * @return The IWorkbookFunctionsCountIfRequest instance
     */
    public IWorkbookFunctionsCountIfRequest buildRequest(final List<Option> requestOptions) {
