...
public class BaseWorkbookFunctionsSinRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsSinRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number) {
     ...
     * @return The IWorkbookFunctionsSinRequest instance
     */
    public IWorkbookFunctionsSinRequest buildRequest(final List<Option> requestOptions) {
