...
public class BaseWorkbookFunctionsEcma_CeilingRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsEcma_CeilingRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement number, final com.google.gson.JsonElement significance) {
     ...
     * @return The IWorkbookFunctionsEcma_CeilingRequest instance
     */
    public IWorkbookFunctionsEcma_CeilingRequest buildRequest(final List<Option> requestOptions) {
