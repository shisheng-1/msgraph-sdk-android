...
public class BaseWorkbookFunctionsNorm_DistRequest extends BaseRequest implements IBaseWorkbookFunctionsNorm_DistRequest {
     ...
     */
    public BaseWorkbookFunctionsNorm_DistRequest(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookFunctionsNorm_DistRequest select(final String value) {
     ...
     * @return The updated request
     */
    public IWorkbookFunctionsNorm_DistRequest top(final int value) {
     ...
     * @return The updated request
     */
    public IWorkbookFunctionsNorm_DistRequest expand(final String value) {
