...
public class BaseWorkbookFunctionsGcdRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsGcdRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsGcdRequest instance
     */
    public IWorkbookFunctionsGcdRequest buildRequest(final List<Option> requestOptions) {
