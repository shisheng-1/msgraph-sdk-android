...
/**
 * The interface for the Base Report Root Get Skype For Business Device Usage User Detail Request Builder.
 */
public interface IBaseReportRootGetSkypeForBusinessDeviceUsageUserDetailRequestBuilder extends IRequestBuilder {
     ...
     * @return The IReportRootGetSkypeForBusinessDeviceUsageUserDetailRequest instance
     */
    IReportRootGetSkypeForBusinessDeviceUsageUserDetailRequest buildRequest(final java.util.List<Option> requestOptions);
}
