...
public class BaseWorkbookFunctionsLcmRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsLcmRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsLcmRequest instance
     */
    public IWorkbookFunctionsLcmRequest buildRequest(final List<Option> requestOptions) {
