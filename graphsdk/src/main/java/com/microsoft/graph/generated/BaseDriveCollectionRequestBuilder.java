...
public class BaseDriveCollectionRequestBuilder extends BaseRequestBuilder implements IBaseDriveCollectionRequestBuilder {
     ...
     */
    public BaseDriveCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
    ...
    public IDriveCollectionRequest buildRequest(final List<Option> requestOptions) {
