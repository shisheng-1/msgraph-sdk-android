...
public class BaseWorkbookFunctionsStDevARequest extends BaseRequest implements IBaseWorkbookFunctionsStDevARequest {
    protected final WorkbookFunctionsStDevABody mBody;
     ...
     */
    public BaseWorkbookFunctionsStDevARequest(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, WorkbookFunctionResult.class);
        mBody = new WorkbookFunctionsStDevABody();
    }
