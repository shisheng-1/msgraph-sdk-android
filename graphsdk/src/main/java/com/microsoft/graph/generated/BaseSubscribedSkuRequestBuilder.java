...
public class BaseSubscribedSkuRequestBuilder extends BaseRequestBuilder implements IBaseSubscribedSkuRequestBuilder {
     ...
     */
    public BaseSubscribedSkuRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options) {
     ...
     */
    public ISubscribedSkuRequest buildRequest(final List<Option> options) {
        return new SubscribedSkuRequest(getRequestUrl(), getClient(), options);
    }
