...
public class BaseSubscribedSkuRequestBuilder extends BaseRequestBuilder implements IBaseSubscribedSkuRequestBuilder {
     ...
     */
    public BaseSubscribedSkuRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public ISubscribedSkuRequest buildRequest(final List<Option> requestOptions) {
