 ...
 */
public class BaseMailFolderCopyRequestBuilder extends BaseRequestBuilder {
    ...
    public IMailFolderCopyRequest buildRequest(final List<Option> options) {
        return new MailFolderCopyRequest(getRequestUrl(), getClient(), options, mDestinationId);
    }
}
