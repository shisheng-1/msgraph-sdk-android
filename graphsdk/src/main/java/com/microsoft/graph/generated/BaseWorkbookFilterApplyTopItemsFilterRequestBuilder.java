...
public class BaseWorkbookFilterApplyTopItemsFilterRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFilterApplyTopItemsFilterRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final Integer count) {
     ...
     * @return The IWorkbookFilterApplyTopItemsFilterRequest instance
     */
    public IWorkbookFilterApplyTopItemsFilterRequest buildRequest(final List<Option> requestOptions) {
