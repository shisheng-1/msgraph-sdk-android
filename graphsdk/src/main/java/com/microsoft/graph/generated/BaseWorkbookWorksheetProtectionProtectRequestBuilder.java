...
public class BaseWorkbookWorksheetProtectionProtectRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookWorksheetProtectionProtectRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final WorkbookWorksheetProtectionOptions options) {
     ...
     * @return The IWorkbookWorksheetProtectionProtectRequest instance
     */
    public IWorkbookWorksheetProtectionProtectRequest buildRequest(final List<Option> requestOptions) {
