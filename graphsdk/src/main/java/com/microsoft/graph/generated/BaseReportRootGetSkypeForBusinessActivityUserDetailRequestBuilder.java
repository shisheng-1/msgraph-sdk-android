...
public class BaseReportRootGetSkypeForBusinessActivityUserDetailRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetSkypeForBusinessActivityUserDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final com.microsoft.graph.model.DateOnly date) {
     ...
     * @param requestOptions The options for this request
     */
    public BaseReportRootGetSkypeForBusinessActivityUserDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
        super(requestUrl, client, requestOptions);
     ...
     * @return The IReportRootGetSkypeForBusinessActivityUserDetailRequest instance
     */
    public IReportRootGetSkypeForBusinessActivityUserDetailRequest buildRequest(final java.util.List<Option> requestOptions) {
