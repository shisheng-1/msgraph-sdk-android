...
public class BaseWorkbookFunctionsSkewRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsSkewRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsSkewRequest instance
     */
    public IWorkbookFunctionsSkewRequest buildRequest(final List<Option> requestOptions) {
