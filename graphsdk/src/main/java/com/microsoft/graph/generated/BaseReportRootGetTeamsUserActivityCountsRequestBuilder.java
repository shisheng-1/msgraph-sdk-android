...
public class BaseReportRootGetTeamsUserActivityCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetTeamsUserActivityCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetTeamsUserActivityCountsRequest instance
     */
    public IReportRootGetTeamsUserActivityCountsRequest buildRequest(final java.util.List<Option> requestOptions) {
