...
public class BaseSingleValueLegacyExtendedPropertyCollectionRequestBuilder extends BaseRequestBuilder implements IBaseSingleValueLegacyExtendedPropertyCollectionRequestBuilder {
     ...
     */
    public BaseSingleValueLegacyExtendedPropertyCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
    ...
    public ISingleValueLegacyExtendedPropertyCollectionRequest buildRequest(final List<Option> requestOptions) {
