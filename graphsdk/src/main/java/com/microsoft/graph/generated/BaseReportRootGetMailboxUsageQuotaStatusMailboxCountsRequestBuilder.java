...
public class BaseReportRootGetMailboxUsageQuotaStatusMailboxCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetMailboxUsageQuotaStatusMailboxCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions, final String period) {
     ...
     * @return The IReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest instance
     */
    public IReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest buildRequest(final java.util.List<Option> requestOptions) {
