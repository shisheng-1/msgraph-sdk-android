...
public class BaseWorkbookFunctionsHarMeanRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsHarMeanRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement values) {
     ...
     * @return The IWorkbookFunctionsHarMeanRequest instance
     */
    public IWorkbookFunctionsHarMeanRequest buildRequest(final List<Option> requestOptions) {
