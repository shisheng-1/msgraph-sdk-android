...
public class BaseWorkbookTableSortReapplyRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookTableSortReapplyRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookTableSortReapplyRequest instance
     */
    public IWorkbookTableSortReapplyRequest buildRequest(final List<Option> requestOptions) {
