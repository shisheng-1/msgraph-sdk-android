...
/**
 * The class for the Base Vpp Token Request Builder.
 */
public class BaseVppTokenRequestBuilder extends BaseRequestBuilder implements IBaseVppTokenRequestBuilder {
     ...
     */
    public BaseVppTokenRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<Option> requestOptions) {
     ...
     */
    public IVppTokenRequest buildRequest(final java.util.List<Option> requestOptions) {
