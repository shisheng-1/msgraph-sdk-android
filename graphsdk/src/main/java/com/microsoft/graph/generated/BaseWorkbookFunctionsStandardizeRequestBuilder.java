...
public class BaseWorkbookFunctionsStandardizeRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseWorkbookFunctionsStandardizeRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final com.google.gson.JsonElement x, final com.google.gson.JsonElement mean, final com.google.gson.JsonElement standardDev) {
     ...
     * @return The IWorkbookFunctionsStandardizeRequest instance
     */
    public IWorkbookFunctionsStandardizeRequest buildRequest(final List<Option> requestOptions) {
