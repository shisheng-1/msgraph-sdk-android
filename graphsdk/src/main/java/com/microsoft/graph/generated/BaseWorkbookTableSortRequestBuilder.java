...
public class BaseWorkbookTableSortRequestBuilder extends BaseRequestBuilder implements IBaseWorkbookTableSortRequestBuilder {
     ...
     */
    public BaseWorkbookTableSortRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IWorkbookTableSortRequest buildRequest(final List<Option> requestOptions) {
        return new WorkbookTableSortRequest(getRequestUrl(), getClient(), requestOptions);
    }


    public IWorkbookTableSortApplyRequestBuilder getApply(final List<WorkbookSortField> fields, final Boolean matchCase, final String method) {
